...
```
```{r}
VAERSSYM_2021_paper <- read_csv("/Users/admin/Downloads/2021VAERSData_06_25_21_396000kb/2021VAERSSYMPTOMS.csv", col_types = cols(VAERS_ID = col_double()))
RV_06_25_21_396000kb <- VAERSSYM_2021_paper %>% select(VAERS_ID, SYMPTOM1, SYMPTOM2, SYMPTOM3, SYMPTOM4, SYMPTOM5)
```
```{r}
SYMPTOM1_LIST_06_25_21_396000kb <- RV_06_25_21_396000kb %>% select(VAERS_ID, SYMPTOM1) %>% rename(SYMPTOM = SYMPTOM1) %>% filter(SYMPTOM != "NA")
Total_number_SYMPTOM1_LIST_06_25_21_396000kb <- SYMPTOM1_LIST_06_25_21_396000kb %>% group_by(VAERS_ID, SYMPTOM) %>% count(SYMPTOM)
SYMPTOM2_LIST_06_25_21_396000kb <- RV_06_25_21_396000kb %>% select(VAERS_ID, SYMPTOM2) %>% rename(SYMPTOM = SYMPTOM2) %>% filter(SYMPTOM != "NA")
Total_number_SYMPTOM2_LIST_06_25_21_396000kb <- SYMPTOM2_LIST_06_25_21_396000kb %>% group_by(VAERS_ID, SYMPTOM) %>% count(SYMPTOM)
SYMPTOM3_LIST_06_25_21_396000kb <- RV_06_25_21_396000kb %>% select(VAERS_ID, SYMPTOM3) %>% rename(SYMPTOM = SYMPTOM3) %>% filter(SYMPTOM != "NA")
Total_number_SYMPTOM3_LIST_06_25_21_396000kb <- SYMPTOM3_LIST_06_25_21_396000kb %>% group_by(VAERS_ID, SYMPTOM) %>% count(SYMPTOM)
SYMPTOM4_LIST_06_25_21_396000kb <- RV_06_25_21_396000kb %>% select(VAERS_ID, SYMPTOM4) %>% rename(SYMPTOM = SYMPTOM4) %>% filter(SYMPTOM != "NA")
Total_number_SYMPTOM4_LIST_06_25_21_396000kb <- SYMPTOM4_LIST_06_25_21_396000kb %>% group_by(VAERS_ID, SYMPTOM) %>% count(SYMPTOM)
SYMPTOM5_LIST_06_25_21_396000kb <- RV_06_25_21_396000kb %>% select(VAERS_ID, SYMPTOM5) %>% rename(SYMPTOM = SYMPTOM5) %>% filter(SYMPTOM != "NA")
Total_number_SYMPTOM5_LIST_06_25_21_396000kb <- SYMPTOM5_LIST_06_25_21_396000kb %>% group_by(VAERS_ID, SYMPTOM) %>% count(SYMPTOM)
```
```{r}
ALL_SYMPTOMS_06_25_21_396000kb <- rbind(SYMPTOM1_LIST_06_25_21_396000kb, SYMPTOM2_LIST_06_25_21_396000kb, SYMPTOM3_LIST_06_25_21_396000kb, SYMPTOM4_LIST_06_25_21_396000kb, SYMPTOM5_LIST_06_25_21_396000kb)
```
```{r}
VAERSDATA_06_25_21_396000kb <- read.csv("/Users/admin/Downloads/2021VAERSData_06_25_21_396000kb/2021VAERSDATA.csv", stringsAsFactors = FALSE)
RV_DATA_06_25_21_396000kb <- VAERSDATA_06_25_21_396000kb %>% select(VAERS_ID, STATE, AGE_YRS,	SEX,	DIED,	DATEDIED,	HOSPITAL,	VAX_DATE,	ONSET_DATE,	TODAYS_DATE, ER_ED_VISIT, L_THREAT, DISABLE, BIRTH_DEFECT, RECVDATE, CAGE_YR, CAGE_MO, ALLERGIES, PRIOR_VAX) 
#RV_DATA_06_25_21_396000kb

RV_DATA_06_25_21_396000kb$VAX_DATE <- as.Date(RV_DATA_06_25_21_396000kb$VAX_DATE, "%m/%d/%y") 
RV_DATA_06_25_21_396000kb$ONSET_DATE <- as.Date(RV_DATA_06_25_21_396000kb$ONSET_DATE, "%m/%d/%y")
RV_DATA_06_25_21_396000kb$DATEDIED <- as.Date(RV_DATA_06_25_21_396000kb$DATEDIED, "%m/%d/%y")
RV_DATA_06_25_21_396000kb$TODAYS_DATE <- as.Date(RV_DATA_06_25_21_396000kb$TODAYS_DATE, "%m/%d/%y")
```
```{r}
VAERSVAX_06_25_21_396000kb <- read_csv("/Users/admin/Downloads/2021VAERSData_06_25_21_396000kb/2021VAERSVAX.csv", col_types = cols(VAERS_ID = col_double()))
RV_VAX_06_25_21_396000kb <- VAERSVAX_06_25_21_396000kb %>% select(VAERS_ID, VAX_TYPE, VAX_MANU, VAX_LOT, VAX_DOSE_SERIES, VAX_ROUTE, VAX_SITE, VAX_NAME) %>% filter(VAX_TYPE == "COVID19")
```
```{r}
MERGED_SYM_DAT_06_25_21_396000kb <- full_join(ALL_SYMPTOMS_06_25_21_396000kb, RV_DATA_06_25_21_396000kb, by = c("VAERS_ID"))
MERGED_SYM_DAT_VAX_06_25_21_396000kb <- full_join(MERGED_SYM_DAT_06_25_21_396000kb, RV_VAX_06_25_21_396000kb, by = c("VAERS_ID"))
```
```{r}
MERGED_SYM_DAT_VAX_06_25_21_396000kb_ID <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% distinct(VAERS_ID, .keep_all = TRUE)

MERGED_SYM_DAT_VAX_06_25_21_396000kb_ENTRY <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_ID %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)
```
```{r}
MERGED_SYM_DAT_VAX_06_25_21_396000kb <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_ENTRY
nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb)
```
```{r}
MERGED_SYM_DAT_VAX_06_25_21_396000kb_count_sym <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(SYMPTOM) %>% count(SYMPTOM) %>% arrange(desc(n))
#MERGED_SYM_DAT_VAX_06_25_21_396000kb_count_sym
MERGED_SYM_DAT_VAX_06_25_21_396000kb_female <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(SEX) %>% count(SEX) %>% mutate("PERC_FEMALE" = n/nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb)*100)
MERGED_SYM_DAT_VAX_06_25_21_396000kb_female
write.csv(MERGED_SYM_DAT_VAX_06_25_21_396000kb,"/Users/admin/Desktop/MERGED_SYM_DAT_VAX_06_25_21_396000kb.csv")
nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb)
```
```{r}
D_06_25_21_396000kb <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(VAERS_ID, DIED) %>% filter(DIED == "Y")
#DEAD_06_25_21_396000kb <- subset(D_06_25_21_396000kb, !duplicated(subset(D_06_25_21_396000kb, select=c(VAERS_ID))))
#nrow(DEAD_06_25_21_396000kb)
```
```{r}
DEAD_Y_06_25_21_396000kb <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(DIED) %>% filter(DIED == "Y")
HOSPITAL_Y_06_25_21_396000kb <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(HOSPITAL) %>% filter(HOSPITAL == "Y")
ER_ED_Y_06_25_21_396000kb <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(ER_ED_VISIT) %>% filter(ER_ED_VISIT == "Y")
L_THREAT_Y_06_25_21_396000kb <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(L_THREAT) %>% filter(L_THREAT == "Y")
DISABLE_Y_06_25_21_396000kb <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(DISABLE) %>% filter(DISABLE == "Y")
BIRTH_DEFECT_Y_06_25_21_396000kb <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(BIRTH_DEFECT) %>% filter(BIRTH_DEFECT == "Y")

SAES_06_25_21_396000kb <- rbind(DEAD_Y_06_25_21_396000kb, HOSPITAL_Y_06_25_21_396000kb, ER_ED_Y_06_25_21_396000kb, L_THREAT_Y_06_25_21_396000kb, DISABLE_Y_06_25_21_396000kb, BIRTH_DEFECT_Y_06_25_21_396000kb)

#SAES_no_dups_06_25_21_396000kb <- subset(SAES_06_25_21_396000kb, !duplicated(subset(SAES_06_25_21_396000kb, select=c(VAERS_ID))))
#nrow(SAES_no_dups_06_25_21_396000kb)
#Percent = nrow(SAES_no_dups_06_25_21_396000kb)/nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb)*100
#Percent
```
...
Table_SAEs <- data.frame(
  ...
  SAE = as.numeric(c("55224", "66255")),
  
  stringsAsFactors = FALSE
)
Table_SAEs_perc <- Table_SAEs %>% mutate("PERC" = round(SAE/(nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb))*100))
...
```
```{r}
CV <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% rowwise() %>% filter(SYMPTOM != "NA") %>% mutate("CARDIOVASCULAR" = CARDIOVASCULAR_human(SYMPTOM)) %>% filter(CARDIOVASCULAR !="NA")
NEURO <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% rowwise() %>% filter(SYMPTOM != "NA") %>% mutate("NEUROLOGICAL" = NEUROLOGICAL_human(SYMPTOM)) %>% filter(NEUROLOGICAL !="NA")
IMMUNO <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% rowwise() %>% filter(SYMPTOM != "NA") %>% mutate("IMMUNOLOGICAL" = IMMUNOLOGICAL_human(SYMPTOM)) %>% filter(IMMUNOLOGICAL !="NA")
```
```{r}
nrow(CV)
nrow(NEURO)
...
MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% rowwise() %>% filter(SYMPTOM != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM)) %>% filter(COVID_CASES != "NA")
MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases <- replace(MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases, "SYMPTOM", "COVID19") 
#nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases)
MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases_dead <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases %>% filter(DIED == "Y") 
#nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases_dead)
Perc_D_BC = (nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases_dead)/nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases)*100)
#Perc_D_BC
```
```{r}
...
```{r}
#png("MERGED_SYM_DAT_VAX_06_25_21_396000kb_count_plot.png", width = 4, height = 4, units = 'in', res = 100)

MERGED_SYM_DAT_VAX_06_25_21_396000kb_AG <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% rowwise() %>% filter(AGE_YRS != "NA") %>% mutate("AGE_GROUP" = AGE_GROUPED_BY_DECADE(AGE_YRS))
MERGED_SYM_DAT_VAX_06_25_21_396000kb_AG_count <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_AG %>% count(AGE_GROUP)
MERGED_SYM_DAT_VAX_06_25_21_396000kb_count_plot <- ggplot(MERGED_SYM_DAT_VAX_06_25_21_396000kb_AG_count, aes(AGE_GROUP, n, fill = AGE_GROUP)) + geom_bar(stat = "Identity") + geom_text(aes(label = n)) + xlab("AGE GROUPS") + ylab("ADVERSE EVENTS (N)") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=25,vjust=0.5,hjust=0.5, size = 8)) + theme(legend.position = "none") + ggtitle("ALL AEs -> Distribution of AGE GROUPS")
MERGED_SYM_DAT_VAX_06_25_21_396000kb_count_plot

MERGED_SYM_DAT_VAX_06_25_21_396000kb_AGE_count <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(AGE_YRS) %>% filter(AGE_YRS != "NA") %>% count(AGE_YRS)
MERGED_SYM_DAT_VAX_06_25_21_396000kb_AGE_count <- data.frame(MERGED_SYM_DAT_VAX_06_25_21_396000kb_AGE_count, stringsAsFactors = FALSE) %>% mutate("skew" = 3*(mean(n)-median(n))/(sd(n)))
#MERGED_SYM_DAT_VAX_06_25_21_396000kb_AGE_count
```
NUMBER OF SPONTANEOUS ABORTIONS
```{r}
MERGED_SYM_DAT_VAX_06_25_21_396000kb_no_dups_SA <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(SYMPTOM) %>% filter(SYMPTOM == "Abortion spontaneous")
nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_no_dups_SA)
```
DISTRIBUTION OF SPONTANEOUS ABORTIONS - THIS SUBSET IS GROWING WEEKLY
```{r}
#png("MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_ID_plot", width = 4, height = 4, units = 'in', res = 100)

MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(SYMPTOM) %>% filter(SYMPTOM == "Abortion spontaneous")
MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_ID <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA %>% group_by(AGE_YRS) %>% filter(AGE_YRS != "NA") %>% count(AGE_YRS)
MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_ID_plot <- ggplot(MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_ID, aes(AGE_YRS, n, fill = AGE_YRS)) + geom_bar(stat = "Identity") + geom_text(aes(label = n)) + xlab("AGE YEARS") + ylab("NUMBER OF SPONTANEOUS ABORTIONS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14))  + theme(legend.position = "none") + ggtitle("SPONTANEOUS ABORTION -> VAERS IDs vs AGE YEARS")
MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_ID_plot
```
```{r}
SA <- data.frame(MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA, stringsAsFactors = FALSE) %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2020) 
MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_VD_OD <- SA %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n)) %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = as.integer(mean(n))) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(SA)*100)
#head(MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_VD_OD)

#chisq.test(MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_VD_OD$OBSERVED)
```
...
CAUSATION_SA_plot <- ggplot() + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + ylab("PERCENTAGE REPORTED SA AEs") + xlab("NUMBER OF DAYS FOLLOWING INJECTION") + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "SPONTANEOUS ABORTIONS post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 12)) + theme(panel.background = element_rect(fill = "#100000")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) 
CAUSATION_SA_plot
```
...
```{r}
SA_VD_OD_TILE_count <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_SA %>% group_by(ONSET_DATE, VAX_DATE) %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2021) %>% filter(year(VAX_DATE) <= 2021 & year(VAX_DATE) >= 2021) %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days)
...
AGE_GROUPS_COVID <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases %>% rowwise() %>% filter(AGE_YRS != "NA") %>% mutate("AGE_GROUP" = AGE_GROUPED_BY_DECADE(AGE_YRS))
...
Table_IDs_COVID_percent <- data.frame(
  ...
  COVID = as.numeric(c("194", "254", "326", "619", "717", "776", "943", "1057", "1169", "1267", "1375", "1404", "1587", "1930", "2776", "3317", "3742", "4285", "4850", "5497", "6151", "6414")),
...
```
```{r}
BCC_count <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases %>% group_by(SYMPTOM, VAX_MANU) %>% count(SYMPTOM)
...
```{r}
no_COVID_sym <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% filter(SYMPTOM != "COVID19")
no_BCC_count_VM <- no_COVID_sym %>% group_by(VAX_MANU) %>% count(VAX_MANU) %>% filter(VAX_MANU != "NA" & VAX_MANU != "UNKNOWN MANUFACTURER") %>% mutate("PERC" = n/(nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb))*100) %>% mutate("Round" = round(PERC, 2))
#no_BCC_count_VM
BCC_count_VM <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases %>% group_by(VAX_MANU) %>% count(VAX_MANU) %>% filter(VAX_MANU != "NA" & VAX_MANU != "UNKNOWN MANUFACTURER") %>% mutate("PERC" = n/(nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases))*100) %>% mutate("Round" = round(PERC, 2))
...
```{r}
BCC_count_VM_dead <- MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases %>% group_by(VAX_MANU, DIED) %>% count(DIED) %>% filter(VAX_MANU != "NA" & VAX_MANU != "UNKNOWN MANUFACTURER" & DIED == "Y") %>% mutate("PERC" = n/(nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_covid_cases))*100) %>% mutate("Round" = round(PERC, 2))
...
```
```{r}
D <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% filter(DIED == "Y") %>% filter(year(DATEDIED) <= 2021 & year(DATEDIED) >= 2020) 
MERGED_SYM_DAT_VAX_06_25_21_396000kb_VD_DD <- D %>% mutate("diff_in_days" = difftime(DATEDIED, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n)) %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = as.integer(mean(n))) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(D)*100)
#head(MERGED_SYM_DAT_VAX_06_25_21_396000kb_VD_DD)

#chisq.test(MERGED_SYM_DAT_VAX_06_25_21_396000kb_VD_DD$OBSERVED)
```
...
```{r}
CAUSATION_DEATH_plot <- ggplot() + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_VD_DD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + ylab("PERCENTAGE OF REPORTED DEATHS") + xlab("NUMBER OF DAYS FOLLOWING INJECTION") + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_VD_DD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "DEATHS post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 12)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
CAUSATION_DEATH_plot
CAUSATION_DEATH_plot_closeup <- ggplot() + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_VD_DD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + ylab("PERCENTAGE OF REPORTED DEATHS") + xlab("NUMBER OF DAYS FOLLOWING INJECTION") + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_VD_DD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "DEATHS post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 12)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + ylim(0,6)
#CAUSATION_DEATH_plot_closeup

D_2021 <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% group_by(VAERS_ID, DIED) %>% filter(DIED == "Y")
...
DEAD_2021_count <- DEAD_2021 %>% group_by(DATEDIED, DIED) %>% count(DIED) %>% arrange(desc(DATEDIED)) %>% mutate("US_tot_death_p_mill_day" = 8697/332458455*1000000) %>% mutate("DIED_FV_p_mill_UR_33" = n/151250000*1000000*33) %>% mutate("DIED_FV_p_mill_UR_100" = n/151250000*1000000*100) %>% mutate("DIED_FV_p_mill_UR_200" = n/151250000*1000000*1000)
#DEAD_2021_count
...
MERGED_SYM_DAT_VAX_06_25_21_396000kb_NEURO_VD_OD <- NEURO_new %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n))  %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/nrow(NEURO_new)*100) %>% mutate("EXPECTED" = mean(n)) %>% mutate("EXPECTED" = mean(n)) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(NEURO_new)*100)
#head(MERGED_SYM_DAT_VAX_06_25_21_396000kb_NEURO_VD_OD)

#chisq.test(MERGED_SYM_DAT_VAX_06_25_21_396000kb_NEURO_VD_OD$OBSERVED)
```
```{r}
CAUSATION_NEURO_plot <- ggplot() + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_NEURO_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + xlab("NUMBER OF DAYS FOLLOWING INJECTION") +  ylab("PERCENTAGE OF REPORTED NEURO AEs") + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_NEURO_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "NEUROLOGICAL AEs post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
CAUSATION_NEURO_plot
CAUSATION_NEURO_plot_closeup <- ggplot() + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_NEURO_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + xlab("NUMBER OF DAYS FOLLOWING INJECTION") +  ylab("PERCENTAGE OF REPORTED NEURO AEs") + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_NEURO_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "NEUROLOGICAL AEs post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + ylim(0,4)
CAUSATION_NEURO_plot_closeup
```
...
MERGED_SYM_DAT_VAX_06_25_21_396000kb_IMMUNO_VD_OD <- IMMUNO_new %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n))  %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/nrow(IMMUNO_new)*100) %>% mutate("EXPECTED" = mean(n)) %>% mutate("EXPECTED" = mean(n)) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(IMMUNO_new)*100)
#head(MERGED_SYM_DAT_VAX_06_25_21_396000kb_IMMUNO_VD_OD)

#chisq.test(MERGED_SYM_DAT_VAX_06_25_21_396000kb_IMMUNO_VD_OD$OBSERVED)
```
```{r}
CAUSATION_IMMUNO_plot <- ggplot() + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_IMMUNO_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + xlab("NUMBER OF DAYS FOLLOWING INJECTION") +  ylab("PERCENTAGE OF REPORTED IMMUNO AEs") + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_IMMUNO_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "IMMUNOLOGICAL AEs post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
CAUSATION_IMMUNO_plot
CAUSATION_IMMUNO_plot_closeup <- ggplot() + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_IMMUNO_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + xlab("NUMBER OF DAYS FOLLOWING INJECTION") +  ylab("PERCENTAGE OF REPORTED IMMUNO AEs") + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_IMMUNO_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "IMMUNOLOGICAL AEs post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + ylim(0,7)
...
I_2021_count <- I_2021 %>% group_by(ONSET_DATE, SYMPTOM) %>% count(SYMPTOM) %>% arrange(desc(ONSET_DATE)) %>% mutate("immuno_FV_p_mill" = n/151250000*1000000) %>% mutate("US_tot_immuno_p_mill_day" = 8697/332458455*1000000) %>% mutate("immuno_FV_p_mill_UR_33" = n/151250000*1000000*33) %>% mutate("immuno_FV_p_mill_UR_100" = n/151250000*1000000*100) %>% mutate("immuno_FV_p_mill_UR_200" = n/151250000*1000000*1000)
#DEAD_2021_count
...
Table_IDs_percent <- data.frame(
  DATE = as.Date(c("1/16/21", "1/23/21", "1/30/21", "2/13/21", "2/27/21", "3/5/21", "3/12/21", "3/19/21", "3/26/21", "4/2/21", "4/9/21", "4/16/21", "4/23/21", "4/30/21", "5/7/21", "5/14/21", "5/21/21", "5/28/21", "6/4/21", "6/11/21", "6/18/21", "6/25/21"), "%m/%d/%y"),
  IDs = as.numeric(c("1431", "2160", "2946", "5351", "9286", "14701", "20586", "27955", "34121", "40348", "46163", "57641", "75370", "108191", "146622", "182559", "217716", "252523", "284041", "316929", "346967", "368162")),
  FV = as.numeric(c("4582089", "7664179", "11037313", "18895522", "27167910", "31720149", "35000000", "44145522", "48700000", "57980000", "64420000", "80610000", "89250000", "99670000", "108930000", "118990000", "126610000", "132770000", "136640000", "141580000", "147760000", "147760000")),
  US_population = as.numeric(c("330175152" , "330175733" , "330176314", "330176895", "330177476", "330178057", "330178638", "330179219", "330179800", "330180381", "330193928", "330209443", "330244315", "330239326", "330757983", "332700813", "332738974", "332371755", "332393075", "332414436", "332888350", "332888350")),
  DEATH = as.numeric(c("137", "281", "456", "810", "984", "1162", "1419", "1561", "1957", "2149", "2240", "2500", "3084", "3442", "3731", "4015", "4169", "4372", "4547", "4700", "4825", "4931")),
  HOSPITAL = as.numeric(c("338", "607", "953", "1747", "2195", "2676", "3412", "3913", "4387", "4758", "4906", "5009", "6215", "8099", "10648", "11557", "12625", "14977", "17520", "19354", "20571", "21636")), 
  ER = as.numeric(c("338", "576", "847", "1493", "2187", "2980", "3855", "4763", "5529", "6329", "6983", "8084", "10375", "14553", "19620", "23641", "27774", "32547", "37184", "41937", "45952", "49511")),
  SAE = as.numeric(c("690", "1207", "1806", "3221", "4291", "5535", "7065", "8470", "9796", "10930", "11724", "13057", "16478", "22145", "29024", "33791", "38650", "44860", "51068", "57073", "61917", "66255")),
  COVID = as.numeric(c("194", "254", "326", "619", "717", "776", "943", "1057", "1169", "1267", "1375", "1404", "1587", "1930", "2776", "3317", "3742", "4285", "4850", "5497", "6151", "6414")), 
  CV = as.numeric(c("271", "417", "586", "1088", "1794", "2707", "3768", "5049", "6079", "7200", "8194", "9872", "12999", "18834", "25254", "31437", "37577", "43979", "50307", "56205", "61839", "66242")),
  NEURO = as.numeric(c("157", "223", "307", "538", "963", "1583", "2347", "3370", "4024", "4706", "5303", "6413", "8122", "11693", "15741", "19493", "23358", "26834", "30369", "34126", "37363", "39703")),
  IMMUNO = as.numeric(c("310", "425", "523", "930", "2360", "4533", "6406", "9150", "11663", "14041", "16480", "21146", "28070", "40021", "54723", "68836", "81954", "92780", "105264", "115281", "124553", "131268")),
  FRI = as.numeric(c("4", "7", "8", "24", "34", "43", "67", "77", "88", "98", "105", "123", "165", "287", "436", "597", "774", "1067", "1421", "1967", "2460", "2940")),
...
```
```{r} 
Table_IDs_percent <- Table_IDs_percent %>% mutate("IDs_normal_ID" = IDs/nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb)*100)
```
```{r}
...
```
```{r}
IDs = as.numeric(c("1431", "2160", "2946", "5351", "9286", "14701", "20586", "27955", "34121", "40348", "46163", "57641", "75370", "108191", "146622", "182559", "217716", "284041", "316929", "346967", "368162"))
(diff(IDs)/(IDs))*100
```
```{r}
...
```
```{r}
FRI_CASES <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% rowwise() %>% filter(SYMPTOM != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM)) %>% filter(Female_Reprod_Issues != "NA")
```
```{r}
nrow(FRI_CASES)
```
...
MERGED_SYM_DAT_VAX_06_25_21_396000kb_FRI_new_VD_OD <- FRI_new %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n))  %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/nrow(FRI_new)*100) %>% mutate("EXPECTED" = mean(n)) %>% mutate("EXPECTED" = mean(n)) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(FRI_new)*100)
#head(MERGED_SYM_DAT_VAX_06_25_21_396000kb_FRI_new_VD_OD)

#chisq.test(MERGED_SYM_DAT_VAX_06_25_21_396000kb_FRI_new_VD_OD$OBSERVED)
```
```{r}
#png("CAUSATION_IMMUNO_plot", width = 4, height = 4, units = 'in', res = 100)

CAUSATION_FRI_new_plot <- ggplot() + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_FRI_new_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + xlab("NUMBER OF DAYS FOLLOWING INJECTION") +  ylab("PERCENTAGE OF REPORTED FRI AEs") + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_FRI_new_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "Female Reproductive Issues post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
CAUSATION_FRI_new_plot
CAUSATION_FRI_new_plot_closeup <- ggplot() + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_FRI_new_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + xlab("NUMBER OF DAYS FOLLOWING INJECTION") +  ylab("PERCENTAGE OF REPORTED FRI AEs") + geom_line(data = MERGED_SYM_DAT_VAX_06_25_21_396000kb_FRI_new_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "Female Reproductive Issues post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + ylim(0,7)
#CAUSATION_FRI_new_plot_closeup
```
```{r}
MERGED_SYM_DAT_VAX_06_25_21_396000kb_FEM <- MERGED_SYM_DAT_VAX_06_25_21_396000kb %>% filter(SEX == "F") 
#nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_FEM)
FRI_CASES_perc <- FRI_CASES %>% count(SYMPTOM) %>% arrange(desc(n)) %>% mutate("PERC" = n/nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_FEM)*100)
#FRI_CASES_perc
```
```{r}
