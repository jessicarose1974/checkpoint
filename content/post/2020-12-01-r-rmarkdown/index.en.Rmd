...
```
```{r}
#write.csv(MERGED_7_1_22_645300kb, "/Users/jessicarose/Desktop/MERGED_7_1_22_645300kb.csv")
```
```{r}
...
```
```{r}
MERGED_7_1_22_645300kb$VAX_DATE <- as.Date(MERGED_7_1_22_645300kb$VAX_DATE, "%m/%d/%y") 
MERGED_7_1_22_645300kb$ONSET_DATE <- as.Date(MERGED_7_1_22_645300kb$ONSET_DATE, "%m/%d/%y")
MERGED_7_1_22_645300kb$DATEDIED <- as.Date(MERGED_7_1_22_645300kb$DATEDIED, "%m/%d/%y")
MERGED_7_1_22_645300kb$TODAYS_DATE <- as.Date(MERGED_7_1_22_645300kb$TODAYS_DATE, "%m/%d/%y")
MERGED_7_1_22_645300kb$RECVDATE <- as.Date(MERGED_7_1_22_645300kb$RECVDATE, "%m/%d/%y")
nrow(MERGED_7_1_22_645300kb)
```
Percent of VAERS reports made by Females
```{r}
MERGED_7_1_22_645300kb_SEX_no_U <- MERGED_7_1_22_645300kb %>% filter(SEX != "U")
MERGED_7_1_22_645300kb_SEX_no_U_F <- MERGED_7_1_22_645300kb_SEX_no_U %>% filter(SEX == "F")
nrow(MERGED_7_1_22_645300kb_SEX_no_U_F)/nrow(MERGED_7_1_22_645300kb)*100
```
...
Table <- data.frame(
  ...
  Dose_1 = as.numeric(c("15840000", "22360000", "29330000", "43170000", "55570000", "64490000", "76320000", "88480000", "100810000", "113530000", "126920000", "138040000", "146410000", "149980000", "158290000", "162850000", "168980000", "173240000", "175910000", "178450000", "180620000", "182600000", "184430000", "186010000", "187820000", "190170000", "193150000", "196470000", "199700000", "202730000", "205600000", "208210000", "210240000", "212270000", "213950000", "215810000", "217410000", "218850000", "220230000", "222160000", "224030000", "224660000", "228180000", "231370000", "237470000", "240320000", "241520000", "241580000", "245650000")),
  DEATH = as.numeric(c("137", "281", "456", "810", "984", "1162", "1419", "1561", "1957", "2149", "2240", "2500", "3084", "3442", "3731", "4015", "4169", "4372", "4547", "4700", "4825", "4931", "5163", "5375", "5508", "5604", "6538", "6639", "6841", "7018", "7149", "7344", "7662", "7859", "8091", "8342", "8606", "8879", "9077", "9315", "9538", "9721", "9931", "10309", "10478", "10651", "10856", "11013", "11166")),
  HOSPITAL = as.numeric(c("338", "607", "953", "1747", "2195", "2676", "3412", "3913", "4387", "4758", "4906", "5009", "6215", "8099", "10648", "11557", "12625", "14977", "17520", "19354", "20571", "21636", "22612", "23441", "24087", "24778", "25634", "26402", "27160", "27913", "28651", "29577", "31041", "32024", "33172", "34288", "35484", "36702", "37769", "38758", "39625", "40465", "41370", "43034", "44126", "45115", "46202", "46933", "47743")), 
  ER = as.numeric(c("338", "576", "847", "1493", "2187", "2980", "3855", "4763", "5529", "6329", "6983", "8084", "10375", "14553", "19620", "23641", "27774", "32547", "37184", "41937", "45952", "49511", "52399", "53789", "55016", "56357", "57820", "59061", "60317", "61754", "63115", "64893", "66657", "68692", "70166", "71831", "73308", "74997", "76423", "78060", "79418", "80584", "81831", "84061", "85266", "86502", "87586", "88549", "89406")),
  SAE = as.numeric(c("690", "1207", "1806", "3221", "4291", "5535", "7065", "8470", "9796", "10930", "11724", "13057", "16478", "22145", "29024", "33791", "38650", "44860", "51068", "57073", "61917", "66255", "69941", "71963", "73645", "75536", "78186", "80011", "81937", "84137", "86209", "88768", "91839", "94740", "97147", "99838", "102373", "105130", "107542", "110045", "112192", "114161", "116275", "120033", "122221", "124345", "126418", "128095", "129701")),
  COVID = as.numeric(c("194", "254", "326", "619", "717", "776", "943", "1057", "1169", "1267", "1375", "1404", "1587", "1930", "2776", "3317", "3742", "4285", "4850", "5497", "6151", "6927", "8324", "9139", "9671", "10199", "10728", "11381", "12174", "13117", "14448", "15979", "17626", "18917", "19953", "21042", "22155", "23358", "24432", "25393", "26240", "26975", "27688", "29272", "30299", "31127", "32039", "32636", "33449")), 
  FRI = as.numeric(c("4", "7", "8", "24", "34", "43", "67", "77", "88", "98", "105", "123", "165", "287", "436", "597", "774", "1067", "1421", "1967", "2460", "2940", "4145", "4934", "5723", "6130", "6538", "6639", "6841", "6904", "7105", "7405", "7722", "8303", "8646", "9153", "9467", "9716" ,"9915", "10194", "10588", "10841", "11096", "11465", "11676", "12040", "12196", "12353", "12470")),
  COVID_deaths = as.numeric(c("38694", "109630", "131892", "170988", "198287", "209042", "218469", "226014", "232899", "238917", "245843", "249289", "253959", "259751", "263832", "269044", "272431", "277845", "280390", "282889", "285210", "287735", "289963", "290463", "292672", "294419", "295971", "299877", "302694", "307669", "316829", "326638", "339140", "354557", "365749", "374992", "389782", "406120", "415867", "426139", "434981", "443473", "451990", "461093", "477787", "490067", "496626", "501166", "516675")),
...
```{r} 
#IDs_normalized_total_IDs <- Table_IDs_percent %>% mutate("IDs_normal_ID" = IDs/nrow(MERGED_7_1_22_645300kb)*100)
...
```
```{r}
MERGED_7_1_22_645300kb_AG <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(AGE_YRS != "NA") %>% mutate("AGE_GROUP" = AGE_GROUPED_BY_DECADE(AGE_YRS))
MERGED_7_1_22_645300kb_AG_count <- MERGED_7_1_22_645300kb_AG %>% count(AGE_GROUP)
MERGED_7_1_22_645300kb_count_plot <- ggplot(MERGED_7_1_22_645300kb_AG_count, aes(AGE_GROUP, n, fill = AGE_GROUP)) + geom_bar(stat = "Identity") + geom_text(aes(label = n)) + xlab("AGE GROUPS") + ylab("ADVERSE EVENTS (N)") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=25,vjust=0.5,hjust=0.5, size = 8)) + theme(legend.position = "none") + ggtitle("ALL AEs -> Distribution of AGE GROUPS")
MERGED_7_1_22_645300kb_count_plot
ggsave("MERGED_7_1_22_645300kb_count_plot.png")

MERGED_7_1_22_645300kb_AGE_count <- MERGED_7_1_22_645300kb %>% group_by(AGE_YRS) %>% filter(AGE_YRS != "NA") %>% count(AGE_YRS)
#MERGED_7_1_22_645300kb_AGE_count <- data.frame(MERGED_7_1_22_645300kb_AGE_count, stringsAsFactors = FALSE) %>% mutate("skew" = 3*(mean(n)-median(n))/(sd(n)))
#MERGED_7_1_22_645300kb_AGE_count
```
This is the number of birth defects.
```{r}
MERGED_7_1_22_645300kb_doses <- MERGED_7_1_22_645300kb %>% group_by(VAX_DOSE_SERIES) %>% filter(VAX_DOSE_SERIES >= 0 & VAX_DOSE_SERIES <= 2) %>% count(VAX_DOSE_SERIES) %>% arrange(desc(n))
#MERGED_7_1_22_645300kb_doses
MERGED_7_1_22_645300kb_doses_VM <- MERGED_7_1_22_645300kb %>% group_by(VAX_DOSE_SERIES, VAX_MANU) %>% filter(VAX_DOSE_SERIES >= 0 & VAX_DOSE_SERIES <= 2 & VAX_MANU != "UNKNOWN MANUFACTURER") %>% count(VAX_DOSE_SERIES) %>% arrange(desc(n)) 
MERGED_7_1_22_645300kb_doses_n <- MERGED_7_1_22_645300kb_doses %>% mutate("SUM" = sum(MERGED_7_1_22_645300kb_doses$n)) %>% mutate("PERCENT" = n/SUM*100)
#MERGED_7_1_22_645300kb_doses_n
```
```{r}
BD_7_1_22_645300kb <- MERGED_7_1_22_645300kb %>% filter(BIRTH_DEFECT == TRUE)
nrow(BD_7_1_22_645300kb)
```
This is the number of deaths and the percentage per total AEs.
```{r}
D_7_1_22_645300kb <- MERGED_7_1_22_645300kb %>% group_by(VAERS_ID, DIED) %>% filter(DIED == "Y")
#nrow(D_7_1_22_645300kb)
#nrow(D_7_1_22_645300kb)/nrow(MERGED_7_1_22_645300kb)*100
```
```{r}
DEAD_MERGED_7_1_22_645300kb <- MERGED_7_1_22_645300kb %>% filter(DIED == "Y")
nrow(DEAD_MERGED_7_1_22_645300kb)
nrow(DEAD_MERGED_7_1_22_645300kb)/nrow(MERGED_7_1_22_645300kb)*100

#DEAD_MERGED_7_1_22_645300kb_VL <- DEAD_MERGED_7_1_22_645300kb %>% group_by(VAX_MANU, VAX_LOT) %>% count(VAX_LOT) %>% arrange(desc(n)) 
#DEAD_MERGED_7_1_22_645300kb_VL <- data.frame(DEAD_MERGED_7_1_22_645300kb_VL, stringsAsFactors = FALSE) %>% mutate("SUM" = as.numeric(sum(n))) %>% mutate("Perc_D_VL_tot" = as.numeric(n/(nrow(DEAD_MERGED_7_1_22_645300kb))*100)) %>% mutate("Round" = round(Perc_D_VL_tot, 2))
#DEAD_MERGED_7_1_22_645300kb_VL
```
```{r}
#let's calculate %age of kids <20 who died
#DEAD_MERGED_7_1_22_645300kb_0_19 <- DEAD_MERGED_7_1_22_645300kb %>% filter(AGE_YRS <= 19)
#DEAD_MERGED_7_1_22_645300kb_0_19
#nrow(DEAD_MERGED_7_1_22_645300kb_0_19)/nrow(DEAD_MERGED_7_1_22_645300kb)*100
```
These are the number of hospitalizations and emergency doctor visits. 
```{r}
HOSPITAL_7_1_22_645300kb  <- MERGED_7_1_22_645300kb  %>% group_by(VAERS_ID, HOSPITAL) %>% filter(HOSPITAL == "Y")
nrow(HOSPITAL_7_1_22_645300kb)

ER_ED_7_1_22_645300kb <- MERGED_7_1_22_645300kb %>% group_by(VAERS_ID, ER_ED_VISIT) %>% filter(ER_ED_VISIT == "Y")
nrow(ER_ED_7_1_22_645300kb)
```
...
```{r}
#MERGED_7_1_22_645300kb_Y_dead
HOSPITAL_Y_7_1_22_645300kb <- MERGED_7_1_22_645300kb %>% filter(HOSPITAL == "Y")
ER_ED_Y_7_1_22_645300kb <- MERGED_7_1_22_645300kb %>% filter(ER_ED_VISIT == "Y")
L_THREAT_Y_7_1_22_645300kb <- MERGED_7_1_22_645300kb %>% filter(L_THREAT == "Y")
DISABLE_Y_7_1_22_645300kb <- MERGED_7_1_22_645300kb %>% filter(DISABLE == "Y")
BIRTH_DEFECT_Y_7_1_22_645300kb <- MERGED_7_1_22_645300kb %>% filter(BIRTH_DEFECT == TRUE)

nrow(DEAD_MERGED_7_1_22_645300kb)
nrow(HOSPITAL_Y_7_1_22_645300kb)
nrow(ER_ED_Y_7_1_22_645300kb)
nrow(L_THREAT_Y_7_1_22_645300kb)
nrow(DISABLE_Y_7_1_22_645300kb)
nrow(BIRTH_DEFECT_Y_7_1_22_645300kb)

SAES_7_1_22_645300kb <- rbind(DEAD_MERGED_7_1_22_645300kb, HOSPITAL_Y_7_1_22_645300kb, ER_ED_Y_7_1_22_645300kb, L_THREAT_Y_7_1_22_645300kb, DISABLE_Y_7_1_22_645300kb, BIRTH_DEFECT_Y_7_1_22_645300kb)

SAES_no_dups_7_1_22_645300kb <- subset(SAES_7_1_22_645300kb, !duplicated(subset(SAES_7_1_22_645300kb, select=c(VAERS_ID))))
nrow(SAES_no_dups_7_1_22_645300kb)
Percent = nrow(SAES_no_dups_7_1_22_645300kb)/nrow(MERGED_7_1_22_645300kb)*100
Percent

#DISABLE_Y_7_1_22_645300kb
```
```{r}
SAES_no_dups_7_1_22_645300kb_fizer <- SAES_no_dups_7_1_22_645300kb %>% filter(VAX_MANU == "PFIZER\\BIONTECH")
nrow(SAES_no_dups_7_1_22_645300kb_fizer)
```
Histogram showing distribution of SAEs according to age group
```{r}
SAES_no_dups_7_1_22_645300kb_AG <- SAES_no_dups_7_1_22_645300kb %>% rowwise() %>% filter(AGE_YRS != "NA") %>% mutate("AGE_GROUP" = AGE_GROUPED_BY_DECADE(AGE_YRS))
SAES_no_dups_7_1_22_645300kb_AG_count <- SAES_no_dups_7_1_22_645300kb_AG %>% count(AGE_GROUP)
SAES_no_dups_7_1_22_645300kb_count_plot <- ggplot(SAES_no_dups_7_1_22_645300kb_AG_count, aes(AGE_GROUP, n, fill = AGE_GROUP)) + geom_bar(stat = "Identity") + geom_text(aes(label = n)) + xlab("AGE GROUPS") + ylab("SEVERE ADVERSE EVENTS (N)") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=25,vjust=0.5,hjust=0.5, size = 8)) + theme(legend.position = "none") + ggtitle("ALL SAEs -> Distribution of AGE GROUPS")
SAES_no_dups_7_1_22_645300kb_count_plot
ggsave("SAES_no_dups_7_1_22_645300kb_count_plot.png")

#MERGED_7_1_22_645300kb_AGE_count <- data.frame(SAES_no_dups_7_1_22_645300kb_AG_count, stringsAsFactors = FALSE) %>% mutate("skew" = 3*(mean(n)-median(n))/(sd(n)))
#MERGED_7_1_22_645300kb_AGE_count
```
...
Table_SAEs <- data.frame(
  ...
  SAE = as.numeric(c("108000", "129701")), #the first number is the SAE/total AE
  
  stringsAsFactors = FALSE
)
Table_SAEs_perc <- Table_SAEs %>% mutate("PERC" = round(SAE/(nrow(MERGED_7_1_22_645300kb))*100))
...
COVID_CASES1 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM1)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES1)
COVID_CASES2 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM2)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES2)
COVID_CASES3 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM3)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES3)
COVID_CASES4 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM4)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES4)
COVID_CASES5 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM5)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES5)
...
nrow(COVID_CASES_Total_ENTRY)/nrow(MERGED_7_1_22_645300kb)*100
```
```{r}
#nrow(COVID_CASES_Total)
#nrow(COVID_CASES_Total_ID)
COVID_CASES <- COVID_CASES_Total_ENTRY
#nrow(COVID_CASES)/nrow(MERGED_7_1_22_645300kb)*100
```
```{r}
...
```
```{r}
no_COVID_CASES_count_VM <- COVID_CASES %>% group_by(VAX_MANU) %>% count(VAX_MANU) %>% filter(VAX_MANU != "NA" & VAX_MANU != "UNKNOWN MANUFACTURER") %>% mutate("PERC" = n/(nrow(MERGED_7_1_22_645300kb))*100) %>% mutate("Round" = round(PERC, 2))
...
MERGED_7_1_22_645300kb_FRI1 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM1)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_7_1_22_645300kb_FRI2 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM2)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_7_1_22_645300kb_FRI3 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM3)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_7_1_22_645300kb_FRI4 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM4)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_7_1_22_645300kb_FRI5 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM5)) %>% filter(Female_Reprod_Issues != "NA")

MERGED_7_1_22_645300kb_FRI_Total <- rbind(MERGED_7_1_22_645300kb_FRI1,MERGED_7_1_22_645300kb_FRI2,MERGED_7_1_22_645300kb_FRI3,MERGED_7_1_22_645300kb_FRI4,MERGED_7_1_22_645300kb_FRI5)
MERGED_7_1_22_645300kb_FRI_Total <- data.frame(MERGED_7_1_22_645300kb_FRI_Total, stringsAsFactors = FALSE)

MERGED_7_1_22_645300kb_FRI_Total_ID <- MERGED_7_1_22_645300kb_FRI_Total %>% distinct(VAERS_ID, .keep_all = TRUE)

MERGED_7_1_22_645300kb_FRI_Total_ENTRY <- MERGED_7_1_22_645300kb_FRI_Total_ID %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)

#nrow(MERGED_7_1_22_645300kb_FRI_Total_ENTRY)
MERGED_7_1_22_645300kb_FRI_Total_ENTRY <- data.frame(MERGED_7_1_22_645300kb_FRI_Total_ENTRY, stringsAsFactors = FALSE)
```

```{r}
FRI_CASES <- MERGED_7_1_22_645300kb_FRI_Total_ENTRY
nrow(FRI_CASES)
nrow(FRI_CASES)/nrow(MERGED_7_1_22_645300kb)*100
```
...
Cardiack1 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM1)) %>% filter(Cardiack != "NA")
#nrow(Cardiack1)
Cardiack2 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM2)) %>% filter(Cardiack != "NA")
#nrow(Cardiack2)
Cardiack3 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM3)) %>% filter(Cardiack != "NA")
#nrow(Cardiack3)
Cardiack4 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM4)) %>% filter(Cardiack != "NA")
#nrow(Cardiack4)
Cardiack5 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM5)) %>% filter(Cardiack != "NA")
#nrow(Cardiack5)
...
#nrow(Cardiack)/nrow(MERGED_7_1_22_645300kb)*100
```
```{r}
...
```{r}
MERGED_7_1_22_645300kb_12_18 <- MERGED_7_1_22_645300kb %>% filter(AGE_YRS >=12 & AGE_YRS <=18)
nrow(MERGED_7_1_22_645300kb_12_18)

MERGED_7_1_22_645300kb_12_18_1 <- MERGED_7_1_22_645300kb_12_18 %>% distinct(VAERS_ID, .keep_all = TRUE)

YOUTH_CASES <- MERGED_7_1_22_645300kb_12_18_1 %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)
...
nrow(YOUTH_CASES)
nrow(YOUTH_CASES)/nrow(MERGED_7_1_22_645300kb)*100
```
...
IAE1 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("IAE" = IAE(SYMPTOM1)) %>% filter(IAE != "NA")
#nrow(IAE1)
IAE2 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("IAE" = IAE(SYMPTOM2)) %>% filter(IAE != "NA")
#nrow(IAE2)
IAE3 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("IAE" = IAE(SYMPTOM3)) %>% filter(IAE != "NA")
#nrow(IAE3)
IAE4 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("IAE" = IAE(SYMPTOM4)) %>% filter(IAE != "NA")
#nrow(IAE4)
IAE5 <- MERGED_7_1_22_645300kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("IAE" = IAE(SYMPTOM5)) %>% filter(IAE != "NA")
#nrow(IAE5)
...
#nrow(IAE)/nrow(MERGED_7_1_22_645300kb)*100
```
```{r}
...
```{r}
D <- MERGED_7_1_22_645300kb %>% filter(DIED == "Y") %>% filter(year(DATEDIED) <= 2021 & year(DATEDIED) >= 2020) 
MERGED_7_1_22_645300kb_VD_DD <- D %>% mutate("diff_in_days" = difftime(DATEDIED, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n)) %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = as.integer(mean(n))) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(D)*100)
MERGED_7_1_22_645300kb_VD_DD

#chisq.test(MERGED_7_1_22_645300kb_VD_DD$OBSERVED)

H <- MERGED_7_1_22_645300kb %>% filter(HOSPITAL == "Y") %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2020)
MERGED_7_1_22_645300kb_H_VD_OD <- H %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n))  %>% mutate("OBSERVED" = n)  %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = mean(n)) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(H)*100)
#head(MERGED_7_1_22_645300kb_H_VD_OD)

#chisq.test(MERGED_7_1_22_645300kb_H_VD_OD$OBSERVED)

ER <- MERGED_7_1_22_645300kb %>% filter(ER_ED_VISIT == "Y") %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2020)
MERGED_7_1_22_645300kb_ER_VD_OD <- ER %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n))  %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = mean(n)) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(ER)*100)
#head(MERGED_7_1_22_645300kb_ER_VD_OD)

#chisq.test(MERGED_7_1_22_645300kb_ER_VD_OD$OBSERVED)
...
```{r}
CAUSATION_DEATH_plot <- ggplot() + geom_line(data = MERGED_7_1_22_645300kb_VD_DD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + ylab("PERCENTAGE OF REPORTED DEATHS") + xlab("NUMBER OF DAYS FOLLOWING INJECTION") + geom_line(data = MERGED_7_1_22_645300kb_VD_DD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "DEATHS post injection", caption = "Data source: VAERS Domestic Data/Analysis: Dr. Jessica Rose") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 12)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
CAUSATION_DEATH_plot 
ggsave("CAUSATION_DEATH_plot.png")
```
```{r}
#MERGED_7_1_22_645300kb_VD_DD_youth <- D %>% filter(AGE_YRS <= 18) %>% mutate("diff_in_days" = difftime(DATEDIED, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n)) %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = as.integer(mean(n))) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(D)*100)
#MERGED_7_1_22_645300kb_VD_DD_youth
#CAUSATION_DEATH_youth_plot <- ggplot() + geom_line(data = MERGED_7_1_22_645300kb_VD_DD_youth, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + ylab("PERCENTAGE OF REPORTED DEATHS in youths (0-18)") + xlab("NUMBER OF DAYS FOLLOWING INJECTION") + labs(title = "DEATHS post injection in children 0-18", caption = "Data source: VAERS Domestic Data/Analysis: Dr. Jessica Rose") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 12)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
#CAUSATION_DEATH_youth_plot + xlim(0,14)
#ggsave("CAUSATION_DEATH_youth_plot.png")
```
```{r}
VD_DD_TILE_count <- MERGED_7_1_22_645300kb %>% group_by(DIED, DATEDIED, VAX_DATE) %>% filter(DIED == "Y") %>% filter(year(DATEDIED) <= 2021 & year(DATEDIED) >= 2021) %>% filter(year(VAX_DATE) <= 2021 & year(VAX_DATE) >= 2021) %>% mutate("diff_in_days" = difftime(DATEDIED, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=350) %>% count(diff_in_days) 
...
```{r}
CAUSATION_ER_plot <- ggplot() + geom_line(data = MERGED_7_1_22_645300kb_ER_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + xlab("NUMBER OF DAYS FOLLOWING INJECTION") +  ylab("PERCENTAGE OF REPORTED ER VISITS") + geom_line(data = MERGED_7_1_22_645300kb_ER_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "ER VISITS post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
CAUSATION_ER_plot 
ggsave("CAUSATION_ER_plot.png")
```

```{r}
ER_VD_OD_TILE_count <- MERGED_7_1_22_645300kb %>% group_by(ER_ED_VISIT, ONSET_DATE, VAX_DATE) %>% filter(ER_ED_VISIT == "Y") %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2021) %>% filter(year(VAX_DATE) <= 2021 & year(VAX_DATE) >= 2021)%>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=350) %>% count(diff_in_days) 
...
```{r}
MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo1 <- MERGED_7_1_22_645300kb %>% filter(SYMPTOM1 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo1)
MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo2 <- MERGED_7_1_22_645300kb %>% filter(SYMPTOM2 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo2)
MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo3 <- MERGED_7_1_22_645300kb %>% filter(SYMPTOM3 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo3)
MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo4 <- MERGED_7_1_22_645300kb %>% filter(SYMPTOM4 == "Myocarditis")
#nrow(MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo4)
MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo5 <- MERGED_7_1_22_645300kb %>% filter(SYMPTOM5 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo5)
myo_Total <- rbind(MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo1,MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo2,MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo3,MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo4,MERGED_SYM_DAT_VAX_7_1_22_645300kb_myo5)
myo_Total <- data.frame(myo_Total, stringsAsFactors = FALSE)
nrow(myo_Total)
nrow(myo_Total)/nrow(Cardiack)*100
nrow(myo_Total)/nrow(MERGED_7_1_22_645300kb)*100
#myo_Total
...
```
```{r}
#MERGED_7_1_22_645300kb_STATE <- MERGED_7_1_22_645300kb %>% count(STATE)
#MERGED_7_1_22_645300kb_STATE
```
```{r}
#MERGED_7_1_22_645300kb_dead <- MERGED_7_1_22_645300kb %>% filter(DIED == "Y")
#MERGED_7_1_22_645300kb_dead_state <- MERGED_7_1_22_645300kb_dead %>% count(STATE) %>% mutate("GT_50" = n >= 50) %>% filter(STATE != "NA") %>% filter(GT_50 == TRUE) %>% arrange(desc(n))
#MERGED_7_1_22_645300kb_dead_state
```