...
```{r}
VAERSSYM_08_27_21_370100kb <- read_csv("/Users/admin/Downloads/2021VAERSData_08_27_21_370100kb/2021VAERSSYMPTOMS.csv", col_types = cols(VAERS_ID = col_double()))
VAERSDATA_08_27_21_370100kb <- read_csv("/Users/admin/Downloads/2021VAERSData_08_27_21_370100kb/2021VAERSDATA.csv", col_types = cols(VAERS_ID = col_double()))
VAERSVAX_08_27_21_370100kb <- read_csv("/Users/admin/Downloads/2021VAERSData_08_27_21_370100kb/2021VAERSVAX.csv", col_types = cols(VAERS_ID = col_double()))
RV_VAX_08_27_21_370100kb <- VAERSVAX_08_27_21_370100kb %>% filter(VAX_TYPE == "COVID19")
MERGED_SYM_DAT_08_27_21_370100kb <- full_join(VAERSSYM_08_27_21_370100kb, VAERSDATA_08_27_21_370100kb, by = c("VAERS_ID"))
MERGED_SYM_DAT_VAX_08_27_21_370100kb <- full_join(MERGED_SYM_DAT_08_27_21_370100kb, RV_VAX_08_27_21_370100kb, by = c("VAERS_ID"))
MERGED_08_27_21_370100kb_1 <- MERGED_SYM_DAT_VAX_08_27_21_370100kb %>% distinct(VAERS_ID, .keep_all = TRUE)
MERGED_08_27_21_370100kb <- MERGED_08_27_21_370100kb_1 %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)

write.csv(MERGED_08_27_21_370100kb, "/Users/admin/Desktop/MERGED_08_27_21_370100kb.csv")
```
```{r}
MERGED_08_27_21_370100kb_Y <- read_csv("/Users/admin/Desktop/MERGED_08_27_21_370100kb_Y.csv")
```
```{r}
MERGED_08_27_21_370100kb <- MERGED_08_27_21_370100kb_Y
```
```{r}
MERGED_08_27_21_370100kb$VAX_DATE <- as.Date(MERGED_08_27_21_370100kb$VAX_DATE, "%m/%d/%y") 
MERGED_08_27_21_370100kb$ONSET_DATE <- as.Date(MERGED_08_27_21_370100kb$ONSET_DATE, "%m/%d/%y")
MERGED_08_27_21_370100kb$DATEDIED <- as.Date(MERGED_08_27_21_370100kb$DATEDIED, "%m/%d/%y")
MERGED_08_27_21_370100kb$TODAYS_DATE <- as.Date(MERGED_08_27_21_370100kb$TODAYS_DATE, "%m/%d/%y")
MERGED_08_27_21_370100kb$RECVDATE <- as.Date(MERGED_08_27_21_370100kb$RECVDATE, "%m/%d/%y")

nrow(MERGED_08_27_21_370100kb)
MERGED_08_27_21_370100kb_count_sym1 <- MERGED_08_27_21_370100kb %>% count(SYMPTOM1) %>% arrange(desc(n))
MERGED_08_27_21_370100kb_count_sym2 <- MERGED_08_27_21_370100kb %>% count(SYMPTOM2) %>% arrange(desc(n))
MERGED_08_27_21_370100kb_count_sym3 <- MERGED_08_27_21_370100kb %>% count(SYMPTOM3) %>% arrange(desc(n))
MERGED_08_27_21_370100kb_count_sym4 <- MERGED_08_27_21_370100kb %>% count(SYMPTOM4) %>% arrange(desc(n))
MERGED_08_27_21_370100kb_count_sym5 <- MERGED_08_27_21_370100kb %>% count(SYMPTOM5) %>% arrange(desc(n))
```
This is the total number of adverse event types.
```{r}
SYM_TOTAL <- sum(nrow(MERGED_08_27_21_370100kb_count_sym1),nrow(MERGED_08_27_21_370100kb_count_sym2),nrow(MERGED_08_27_21_370100kb_count_sym3),nrow(MERGED_08_27_21_370100kb_count_sym4),nrow(MERGED_08_27_21_370100kb_count_sym5))
SYM_TOTAL 
```
Percent of VAERS reports made by Females
```{r}
MERGED_08_27_21_370100kb_SEX_no_U <- MERGED_08_27_21_370100kb %>% filter(SEX != "U")
MERGED_08_27_21_370100kb_SEX_no_U_F <- MERGED_08_27_21_370100kb_SEX_no_U %>% filter(SEX == "F")
nrow(MERGED_08_27_21_370100kb_SEX_no_U_F)/nrow(MERGED_08_27_21_370100kb)*100
```
...
```{r}
Table <- data.frame(
  DATE = as.Date(c("1/16/21", "1/23/21", "1/30/21", "2/13/21", "2/27/21", "3/5/21", "3/12/21", "3/19/21", "3/26/21", "4/2/21", "4/9/21", "4/16/21", "4/23/21", "4/30/21", "5/7/21", "5/14/21", "5/21/21", "5/28/21", "6/4/21", "6/11/21", "6/18/21", "6/25/21", "7/2/21", "7/9/21", "7/16/21", "7/23/21", "7/30/21", "8/6/21", "8/13/21", "8/20/21", "8/27/21"), "%m/%d/%y"),
  IDs = as.numeric(c("1431", "2160", "2946", "5351", "9286", "14701", "20586", "27955", "34121", "40348", "46163", "57641", "75370", "108191", "146622", "182559", "217716", "252523", "284041", "316929", "346967", "368162", "388900", "397262", "403335", "409924", "419295", "427831", "436175", "450602", "473722")),
  ...
  DEATH = as.numeric(c("137", "281", "456", "810", "984", "1162", "1419", "1561", "1957", "2149", "2240", "2500", "3084", "3442", "3731", "4015", "4169", "4372", "4547", "4700", "4825", "4931", "5163", "5375", "5508", "5604", "6538", "6639", "6841", "7018", "7149")),
  HOSPITAL = as.numeric(c("338", "607", "953", "1747", "2195", "2676", "3412", "3913", "4387", "4758", "4906", "5009", "6215", "8099", "10648", "11557", "12625", "14977", "17520", "19354", "20571", "21636", "22612", "23441", "24087", "24778", "25634", "26402", "27160", "27913", "28651")), 
  ER = as.numeric(c("338", "576", "847", "1493", "2187", "2980", "3855", "4763", "5529", "6329", "6983", "8084", "10375", "14553", "19620", "23641", "27774", "32547", "37184", "41937", "45952", "49511", "52399", "53789", "55016", "56357", "57820", "59061", "60317", "61754", "63115")),
  SAE = as.numeric(c("690", "1207", "1806", "3221", "4291", "5535", "7065", "8470", "9796", "10930", "11724", "13057", "16478", "22145", "29024", "33791", "38650", "44860", "51068", "57073", "61917", "66255", "69941", "71963", "73645", "75536", "78186", "80011", "81937", "84137", "86209")),
  COVID = as.numeric(c("194", "254", "326", "619", "717", "776", "943", "1057", "1169", "1267", "1375", "1404", "1587", "1930", "2776", "3317", "3742", "4285", "4850", "5497", "6151", "6414", "9442", "9721", "9939", "10212", "10728", "11381", "12174", "13117", "14448")), 
  FRI = as.numeric(c("4", "7", "8", "24", "34", "43", "67", "77", "88", "98", "105", "123", "165", "287", "436", "597", "774", "1067", "1421", "1967", "2460", "2940", "5351", "5557", "5723", "5946", "6538", "6639", "6841", "6904", "7105")),
...
Table_IDs_percent <- data.frame(
  DATE = as.Date(c("1/16/21", "1/23/21", "1/30/21", "2/13/21", "2/27/21", "3/5/21", "3/12/21", "3/19/21", "3/26/21", "4/2/21", "4/9/21", "4/16/21", "4/23/21", "4/30/21", "5/7/21", "5/14/21", "5/21/21", "5/28/21", "6/4/21", "6/11/21", "6/18/21", "6/25/21", "7/2/21", "7/9/21", "7/16/21", "7/23/21", "7/30/21", "8/6/21", "8/13/21", "8/20/21", "8/27/21"), "%m/%d/%y"),
  IDs = as.numeric(c("1431", "2160", "2946", "5351", "9286", "14701", "20586", "27955", "34121", "40348", "46163", "57641", "75370", "108191", "146622", "182559", "217716", "252523", "284041", "316929", "346967", "368162", "388900", "397262", "403335", "409924", "419295", "427831", "436175", "450602", "473721")),
  FV = as.numeric(c("4582089", "7664179", "11037313", "18895522", "27167910", "31720149", "35000000", "44145522", "48700000", "57980000", "64420000", "80610000", "89250000", "99670000", "108930000", "118990000", "126610000", "132770000", "136640000", "141580000", "148460000", "151620000", "155880000", "158290000", "160410000", "162170000", "163870000", "165640000", "167350000", "169590000", "172170000")),
  DEATH = as.numeric(c("137", "281", "456", "810", "984", "1162", "1419", "1561", "1957", "2149", "2240", "2500", "3084", "3442", "3731", "4015", "4169", "4372", "4547", "4700", "4825", "4931", "5163", "5375", "5508", "5604", "6538", "6639", "6841", "7018", "7149")),
  HOSPITAL = as.numeric(c("338", "607", "953", "1747", "2195", "2676", "3412", "3913", "4387", "4758", "4906", "5009", "6215", "8099", "10648", "11557", "12625", "14977", "17520", "19354", "20571", "21636", "22612", "23441", "24087", "24778", "25634", "26402", "27160", "27913", "28651")), 
  ER = as.numeric(c("338", "576", "847", "1493", "2187", "2980", "3855", "4763", "5529", "6329", "6983", "8084", "10375", "14553", "19620", "23641", "27774", "32547", "37184", "41937", "45952", "49511", "52399", "53789", "55016", "56357", "57820", "59061", "60317", "61754", "63115")),
...
```{r}
IDs = as.numeric(c("1431", "2160", "2946", "5351", "9286", "14701", "20586", "27955", "34121", "40348", "46163", "57641", "75370", "108191", "146622", "182559", "217716", "252523", "284041", "316929", "346967", "368162", "388900", "397262", "403335", "409024", "419295", "427831", "436175", "450602", "473721"))
#(diff(IDs)/(IDs))*100
```
...
```{r} 
IDs_normalized_total_IDs <- Table_IDs_percent %>% mutate("IDs_normal_ID" = IDs/nrow(MERGED_08_27_21_370100kb)*100)
...
```
```{r}
MERGED_08_27_21_370100kb_AG <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(AGE_YRS != "NA") %>% mutate("AGE_GROUP" = AGE_GROUPED_BY_DECADE(AGE_YRS))
MERGED_08_27_21_370100kb_AG_count <- MERGED_08_27_21_370100kb_AG %>% count(AGE_GROUP)
MERGED_08_27_21_370100kb_count_plot <- ggplot(MERGED_08_27_21_370100kb_AG_count, aes(AGE_GROUP, n, fill = AGE_GROUP)) + geom_bar(stat = "Identity") + geom_text(aes(label = n)) + xlab("AGE GROUPS") + ylab("ADVERSE EVENTS (N)") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=25,vjust=0.5,hjust=0.5, size = 8)) + theme(legend.position = "none") + ggtitle("ALL AEs -> Distribution of AGE GROUPS")
MERGED_08_27_21_370100kb_count_plot
ggsave("MERGED_08_27_21_370100kb_count_plot.png")

MERGED_08_27_21_370100kb_AGE_count <- MERGED_08_27_21_370100kb %>% group_by(AGE_YRS) %>% filter(AGE_YRS != "NA") %>% count(AGE_YRS)
#MERGED_08_27_21_370100kb_AGE_count <- data.frame(MERGED_08_27_21_370100kb_AGE_count, stringsAsFactors = FALSE) %>% mutate("skew" = 3*(mean(n)-median(n))/(sd(n)))
#MERGED_08_27_21_370100kb_AGE_count
```
This is the number of birth defects.
```{r}
MERGED_08_27_21_370100kb_doses <- MERGED_08_27_21_370100kb %>% group_by(VAX_DOSE_SERIES) %>% filter(VAX_DOSE_SERIES >= 0 & VAX_DOSE_SERIES <= 2) %>% count(VAX_DOSE_SERIES) %>% arrange(desc(n))
#MERGED_08_27_21_370100kb_doses
MERGED_08_27_21_370100kb_doses_VM <- MERGED_08_27_21_370100kb %>% group_by(VAX_DOSE_SERIES, VAX_MANU) %>% filter(VAX_DOSE_SERIES >= 0 & VAX_DOSE_SERIES <= 2 & VAX_MANU != "UNKNOWN MANUFACTURER") %>% count(VAX_DOSE_SERIES) %>% arrange(desc(n)) 
MERGED_08_27_21_370100kb_doses_n <- MERGED_08_27_21_370100kb_doses %>% mutate("SUM" = sum(MERGED_08_27_21_370100kb_doses$n)) %>% mutate("PERCENT" = n/SUM*100)
#MERGED_08_27_21_370100kb_doses_n
```
```{r}
BD_08_27_21_370100kb <- MERGED_08_27_21_370100kb %>% filter(BIRTH_DEFECT == TRUE)
nrow(BD_08_27_21_370100kb)
```
This is the number of deaths and the percentage per total AEs.
```{r}
D_08_27_21_370100kb <- MERGED_08_27_21_370100kb %>% group_by(VAERS_ID, DIED) %>% filter(DIED == "Y")
#nrow(D_08_27_21_370100kb)
#nrow(D_08_27_21_370100kb)/nrow(MERGED_08_27_21_370100kb)*100
```
```{r}
DEAD_MERGED_08_27_21_370100kb <- MERGED_08_27_21_370100kb %>% filter(DIED == "Y")
nrow(DEAD_MERGED_08_27_21_370100kb)
nrow(DEAD_MERGED_08_27_21_370100kb)/nrow(MERGED_08_27_21_370100kb)*100
```
These are the number of hospitalizations and emergency doctor visits. 
```{r}
HOSPITAL_08_27_21_370100kb  <- MERGED_08_27_21_370100kb  %>% group_by(VAERS_ID, HOSPITAL) %>% filter(HOSPITAL == "Y")
nrow(HOSPITAL_08_27_21_370100kb)

ER_ED_08_27_21_370100kb <- MERGED_08_27_21_370100kb %>% group_by(VAERS_ID, ER_ED_VISIT) %>% filter(ER_ED_VISIT == "Y")
nrow(ER_ED_08_27_21_370100kb)
```
...
```{r}
#MERGED_08_27_21_370100kb_Y_dead
HOSPITAL_Y_08_27_21_370100kb <- MERGED_08_27_21_370100kb %>% filter(HOSPITAL == "Y")
ER_ED_Y_08_27_21_370100kb <- MERGED_08_27_21_370100kb %>% filter(ER_ED_VISIT == "Y")
L_THREAT_Y_08_27_21_370100kb <- MERGED_08_27_21_370100kb %>% filter(L_THREAT == "Y")
DISABLE_Y_08_27_21_370100kb <- MERGED_08_27_21_370100kb %>% filter(DISABLE == "Y")
BIRTH_DEFECT_Y_08_27_21_370100kb <- MERGED_08_27_21_370100kb %>% filter(BIRTH_DEFECT == TRUE)

nrow(DEAD_MERGED_08_27_21_370100kb)
nrow(HOSPITAL_Y_08_27_21_370100kb)
nrow(ER_ED_Y_08_27_21_370100kb)
nrow(L_THREAT_Y_08_27_21_370100kb)
nrow(DISABLE_Y_08_27_21_370100kb)
nrow(BIRTH_DEFECT_Y_08_27_21_370100kb)

SAES_08_27_21_370100kb <- rbind(DEAD_MERGED_08_27_21_370100kb, HOSPITAL_Y_08_27_21_370100kb, ER_ED_Y_08_27_21_370100kb, L_THREAT_Y_08_27_21_370100kb, DISABLE_Y_08_27_21_370100kb, BIRTH_DEFECT_Y_08_27_21_370100kb)

SAES_no_dups_08_27_21_370100kb <- subset(SAES_08_27_21_370100kb, !duplicated(subset(SAES_08_27_21_370100kb, select=c(VAERS_ID))))
nrow(SAES_no_dups_08_27_21_370100kb)
Percent = nrow(SAES_no_dups_08_27_21_370100kb)/nrow(MERGED_08_27_21_370100kb)*100
Percent
```
Histogram showing distribution of SAEs according to age group
```{r}
SAES_no_dups_08_27_21_370100kb_AG <- SAES_no_dups_08_27_21_370100kb %>% rowwise() %>% filter(AGE_YRS != "NA") %>% mutate("AGE_GROUP" = AGE_GROUPED_BY_DECADE(AGE_YRS))
SAES_no_dups_08_27_21_370100kb_AG_count <- SAES_no_dups_08_27_21_370100kb_AG %>% count(AGE_GROUP)
SAES_no_dups_08_27_21_370100kb_count_plot <- ggplot(SAES_no_dups_08_27_21_370100kb_AG_count, aes(AGE_GROUP, n, fill = AGE_GROUP)) + geom_bar(stat = "Identity") + geom_text(aes(label = n)) + xlab("AGE GROUPS") + ylab("SEVERE ADVERSE EVENTS (N)") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=25,vjust=0.5,hjust=0.5, size = 8)) + theme(legend.position = "none") + ggtitle("ALL SAEs -> Distribution of AGE GROUPS")
SAES_no_dups_08_27_21_370100kb_count_plot
ggsave("SAES_no_dups_08_27_21_370100kb_count_plot.png")

#MERGED_08_27_21_370100kb_AGE_count <- data.frame(SAES_no_dups_08_27_21_370100kb_AG_count, stringsAsFactors = FALSE) %>% mutate("skew" = 3*(mean(n)-median(n))/(sd(n)))
#MERGED_08_27_21_370100kb_AGE_count
```
...
Table_SAEs <- data.frame(
  ...
  SAE = as.numeric(c("70000", "86209")), #the first number is the SAE/total AE
  
  stringsAsFactors = FALSE
)
Table_SAEs_perc <- Table_SAEs %>% mutate("PERC" = round(SAE/(nrow(MERGED_08_27_21_370100kb))*100))
...
COVID_CASES1 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM1)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES1)
COVID_CASES2 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM2)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES2)
COVID_CASES3 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM3)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES3)
COVID_CASES4 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM4)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES4)
COVID_CASES5 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM5)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES5)
...
nrow(COVID_CASES_Total_ENTRY)/nrow(MERGED_08_27_21_370100kb)*100
```
```{r}
#nrow(COVID_CASES_Total)
#nrow(COVID_CASES_Total_ID)
COVID_CASES <- COVID_CASES_Total_ENTRY
#nrow(COVID_CASES)/nrow(MERGED_08_27_21_370100kb)*100
```
```{r}
...
Table_IDs_COVID_percent <- data.frame(
  DATE = as.Date(c("1/16/21", "1/23/21", "1/30/21", "2/13/21", "2/27/21", "3/5/21", "3/12/21", "3/19/21", "3/26/21", "4/2/21", "4/9/21", "4/16/21", "4/23/21", "4/30/21", "5/7/21", "5/12/21", "5/19/21", "5/28/21", "6/4/21", "6/11/21", "6/18/21", "6/25/21", "7/2/21", "7/9/21", "7/16/21", "7/23/21", "7/30/21", "8/6/21", "8/13/21", "8/20/21", "8/27/21"), "%m/%d/%y"),
  COVID = as.numeric(c("194", "254", "326", "619", "717", "776", "943", "1057", "1169", "1267", "1375", "1404", "1587", "1930", "2776", "3317", "3742", "4285", "4850", "5497", "6151", "6414", "7703", "9721", "9939", "10212", "10728", "11381", "12174", "13117", "14448")),
...
```
```{r}
no_COVID_CASES_count_VM <- COVID_CASES %>% group_by(VAX_MANU) %>% count(VAX_MANU) %>% filter(VAX_MANU != "NA" & VAX_MANU != "UNKNOWN MANUFACTURER") %>% mutate("PERC" = n/(nrow(MERGED_08_27_21_370100kb))*100) %>% mutate("Round" = round(PERC, 2))
...
MERGED_08_27_21_370100kb_FRI1 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM1)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_08_27_21_370100kb_FRI2 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM2)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_08_27_21_370100kb_FRI3 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM3)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_08_27_21_370100kb_FRI4 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM4)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_08_27_21_370100kb_FRI5 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM5)) %>% filter(Female_Reprod_Issues != "NA")

MERGED_08_27_21_370100kb_FRI_Total <- rbind(MERGED_08_27_21_370100kb_FRI1,MERGED_08_27_21_370100kb_FRI2,MERGED_08_27_21_370100kb_FRI3,MERGED_08_27_21_370100kb_FRI4,MERGED_08_27_21_370100kb_FRI5)
MERGED_08_27_21_370100kb_FRI_Total <- data.frame(MERGED_08_27_21_370100kb_FRI_Total, stringsAsFactors = FALSE)

MERGED_08_27_21_370100kb_FRI_Total_ID <- MERGED_08_27_21_370100kb_FRI_Total %>% distinct(VAERS_ID, .keep_all = TRUE)

MERGED_08_27_21_370100kb_FRI_Total_ENTRY <- MERGED_08_27_21_370100kb_FRI_Total_ID %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)

#nrow(MERGED_08_27_21_370100kb_FRI_Total_ENTRY)
MERGED_08_27_21_370100kb_FRI_Total_ENTRY <- data.frame(MERGED_08_27_21_370100kb_FRI_Total_ENTRY, stringsAsFactors = FALSE)
```
```{r}
#nrow(MERGED_08_27_21_370100kb_FRI1)
#nrow(MERGED_08_27_21_370100kb_FRI2)
#nrow(MERGED_08_27_21_370100kb_FRI3)
#nrow(MERGED_08_27_21_370100kb_FRI4)
#nrow(MERGED_08_27_21_370100kb_FRI5)
#MERGED_08_27_21_370100kb_FRI_Total
```
```{r}
#nrow(MERGED_08_27_21_370100kb_FRI_Total)
#nrow(MERGED_08_27_21_370100kb_FRI_Total_ID)
FRI_CASES <- MERGED_08_27_21_370100kb_FRI_Total_ENTRY
nrow(FRI_CASES)
nrow(FRI_CASES)/nrow(MERGED_08_27_21_370100kb)*100

#FRI_CASES_amenor1 <- FRI_CASES %>% filter(SYMPTOM1 == "Amenorrhoea") %>% count("SYMPTOM1")
#FRI_CASES_amenor2 <- FRI_CASES %>% filter(SYMPTOM2 == "Amenorrhoea") %>% count("SYMPTOM2")
#FRI_CASES_amenor3 <- FRI_CASES %>% filter(SYMPTOM3 == "Amenorrhoea") %>% count("SYMPTOM3")
#FRI_CASES_amenor4 <- FRI_CASES %>% filter(SYMPTOM4 == "Amenorrhoea") %>% count("SYMPTOM4")
#FRI_CASES_amenor5 <- FRI_CASES %>% filter(SYMPTOM5 == "Amenorrhoea") %>% count("SYMPTOM5")
#FRI_CASES_amenor1
#FRI_CASES_amenor2
#FRI_CASES_amenor3
#FRI_CASES_amenor4
...
Cardiack1 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM1)) %>% filter(Cardiack != "NA")
#nrow(Cardiack1)
Cardiack2 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM2)) %>% filter(Cardiack != "NA")
#nrow(Cardiack2)
Cardiack3 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM3)) %>% filter(Cardiack != "NA")
#nrow(Cardiack3)
Cardiack4 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM4)) %>% filter(Cardiack != "NA")
#nrow(Cardiack4)
Cardiack5 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM5)) %>% filter(Cardiack != "NA")
#nrow(Cardiack5)
...
#nrow(Cardiack)/nrow(MERGED_08_27_21_370100kb)*100
```
```{r}
...
```{r}
MERGED_08_27_21_370100kb_12_18 <- MERGED_08_27_21_370100kb %>% filter(AGE_YRS >=12 & AGE_YRS <=18)
nrow(MERGED_08_27_21_370100kb_12_18)

MERGED_08_27_21_370100kb_12_18_1 <- MERGED_08_27_21_370100kb_12_18 %>% distinct(VAERS_ID, .keep_all = TRUE)

YOUTH_CASES <- MERGED_08_27_21_370100kb_12_18_1 %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)
...
nrow(YOUTH_CASES)
nrow(YOUTH_CASES)/nrow(MERGED_08_27_21_370100kb)*100
```
...
IAE1 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("IAE" = IAE(SYMPTOM1)) %>% filter(IAE != "NA")
#nrow(IAE1)
IAE2 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("IAE" = IAE(SYMPTOM2)) %>% filter(IAE != "NA")
#nrow(IAE2)
IAE3 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("IAE" = IAE(SYMPTOM3)) %>% filter(IAE != "NA")
#nrow(IAE3)
IAE4 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("IAE" = IAE(SYMPTOM4)) %>% filter(IAE != "NA")
#nrow(IAE4)
IAE5 <- MERGED_08_27_21_370100kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("IAE" = IAE(SYMPTOM5)) %>% filter(IAE != "NA")
#nrow(IAE5)
...
#nrow(IAE)/nrow(MERGED_08_27_21_370100kb)*100
```
```{r}
...
```{r}
D <- MERGED_08_27_21_370100kb %>% filter(DIED == "Y") %>% filter(year(DATEDIED) <= 2021 & year(DATEDIED) >= 2020) 
MERGED_08_27_21_370100kb_VD_DD <- D %>% mutate("diff_in_days" = difftime(DATEDIED, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n)) %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = as.integer(mean(n))) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(D)*100)
#head(MERGED_08_27_21_370100kb_VD_DD)

#chisq.test(MERGED_08_27_21_370100kb_VD_DD$OBSERVED)

H <- MERGED_08_27_21_370100kb %>% filter(HOSPITAL == "Y") %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2020)
MERGED_08_27_21_370100kb_H_VD_OD <- H %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n))  %>% mutate("OBSERVED" = n)  %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = mean(n)) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(H)*100)
#head(MERGED_08_27_21_370100kb_H_VD_OD)

#chisq.test(MERGED_08_27_21_370100kb_H_VD_OD$OBSERVED)

ER <- MERGED_08_27_21_370100kb %>% filter(ER_ED_VISIT == "Y") %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2020)
MERGED_08_27_21_370100kb_ER_VD_OD <- ER %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n))  %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = mean(n)) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(ER)*100)
#head(MERGED_08_27_21_370100kb_ER_VD_OD)

#chisq.test(MERGED_08_27_21_370100kb_ER_VD_OD$OBSERVED)
...
```
```{r}
CAUSATION_DEATH_plot <- ggplot() + geom_line(data = MERGED_08_27_21_370100kb_VD_DD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + ylab("PERCENTAGE OF REPORTED DEATHS") + xlab("NUMBER OF DAYS FOLLOWING INJECTION") + geom_line(data = MERGED_08_27_21_370100kb_VD_DD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "DEATHS post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 12)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) 
CAUSATION_DEATH_plot 
ggsave("CAUSATION_DEATH_plot.png")
```

```{r}
VD_DD_TILE_count <- MERGED_08_27_21_370100kb %>% group_by(DIED, DATEDIED, VAX_DATE) %>% filter(DIED == "Y") %>% filter(year(DATEDIED) <= 2021 & year(DATEDIED) >= 2021) %>% filter(year(VAX_DATE) <= 2021 & year(VAX_DATE) >= 2021)%>% mutate("diff_in_days" = difftime(DATEDIED, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) 
...
```{r}
CAUSATION_HOSP_plot <- ggplot() + geom_line(data = MERGED_08_27_21_370100kb_H_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + xlab("NUMBER OF DAYS FOLLOWING INJECTION") +  ylab("PERCENTAGE OF REPORTED HOSPITALIZATIONS") + geom_line(data = MERGED_08_27_21_370100kb_H_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "HOSPITALIZATIONS post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
CAUSATION_HOSP_plot
ggsave("CAUSATION_HOSP_plot.png")
```

```{r}
H_VD_OD_TILE_count <- MERGED_08_27_21_370100kb %>% group_by(HOSPITAL, ONSET_DATE, VAX_DATE) %>% filter(HOSPITAL == "Y") %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2021) %>% filter(year(VAX_DATE) <= 2021 & year(VAX_DATE) >= 2021)%>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) 
...
```{r}
MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo1 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM1 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo1)
MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo2 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM2 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo2)
MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo3 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM3 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo3)
MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo4 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM4 == "Myocarditis")
#nrow(MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo4)
MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo5 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM5 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo5)
myo_Total <- rbind(MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo1,MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo2,MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo3,MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo4,MERGED_SYM_DAT_VAX_08_27_21_370100kb_myo5)
myo_Total <- data.frame(myo_Total, stringsAsFactors = FALSE)
nrow(myo_Total)
nrow(myo_Total)/nrow(Cardiack)*100
nrow(myo_Total)/nrow(MERGED_08_27_21_370100kb)*100
#myo_Total
...
ggsave("myo_Total_ENTRY_count_VDS_plot.png")
```
```{r}
#MERGED_08_27_21_370100kb_death_1 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM1 == "Death") 
#nrow(MERGED_08_27_21_370100kb_death_1)
#MERGED_08_27_21_370100kb_death_2 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM2 == "Death") 
#nrow(MERGED_08_27_21_370100kb_death_2)
#MERGED_08_27_21_370100kb_death_3 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM3 == "Death") 
#nrow(MERGED_08_27_21_370100kb_death_3)
#MERGED_08_27_21_370100kb_death_4 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM4 == "Death")
#nrow(MERGED_08_27_21_370100kb_death_4)
#MERGED_08_27_21_370100kb_death_5 <- MERGED_08_27_21_370100kb %>% filter(SYMPTOM5 == "Death") 
#nrow(MERGED_08_27_21_370100kb_death_5)
#death_Total <- rbind(MERGED_08_27_21_370100kb_death_1,MERGED_08_27_21_370100kb_death_2,MERGED_08_27_21_370100kb_death_3,MERGED_08_27_21_370100kb_death_4,MERGED_08_27_21_370100kb_death_5)
#death_Total <- data.frame(death_Total, stringsAsFactors = FALSE)
#nrow(death_Total)
#nrow(death_Total)/nrow(MERGED_08_27_21_370100kb)*100
#death_Total
#death_Total_count <- death_Total %>% count(SYMPTOM1,SYMPTOM2,SYMPTOM3,SYMPTOM4,SYMPTOM5) %>% mutate("SUM" = sum(n)) %>% arrange(desc(n))
#death_Total_count

#death_Total_ID <- death_Total %>% distinct(VAERS_ID, .keep_all = TRUE)

#death_Total_ENTRY <- death_Total_ID %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)
```
```{r}
#MERGED_08_27_21_370100kb_Death <- MERGED_08_27_21_370100kb %>% filter(DIED == "Y") %>% count(DIED)
#MERGED_08_27_21_370100kb_Death

#MERGED_SYM_DAT_VAX_08_27_21_370100kb_Death <- MERGED_SYM_DAT_VAX_08_27_21_370100kb %>% filter(DIED == "Y") %>% count(DIED)
#MERGED_SYM_DAT_VAX_08_27_21_370100kb_Death

#MERGED_08_27_21_370100kb_1_Death <- MERGED_08_27_21_370100kb_1 %>% filter(DIED == "Y") %>% count(DIED)
#MERGED_08_27_21_370100kb_1_Death
```