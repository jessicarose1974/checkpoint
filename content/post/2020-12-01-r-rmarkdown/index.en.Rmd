...
```{r}
VAERSSYM_07_16_21_284800kb <- read_csv("/Users/admin/Downloads/2021VAERSData_07_16_21_284800kb/2021VAERSSYMPTOMS.csv", col_types = cols(VAERS_ID = col_double()))
VAERSDATA_07_16_21_284800kb <- read_csv("/Users/admin/Downloads/2021VAERSData_07_16_21_284800kb/2021VAERSDATA.csv", col_types = cols(VAERS_ID = col_double()))
VAERSVAX_07_16_21_284800kb <- read_csv("/Users/admin/Downloads/2021VAERSData_07_16_21_284800kb/2021VAERSVAX.csv", col_types = cols(VAERS_ID = col_double()))
RV_VAX_07_16_21_284800kb <- VAERSVAX_07_16_21_284800kb %>% filter(VAX_TYPE == "COVID19")
MERGED_SYM_DAT_07_16_21_284800kb <- full_join(VAERSSYM_07_16_21_284800kb, VAERSDATA_07_16_21_284800kb, by = c("VAERS_ID"))
MERGED_SYM_DAT_VAX_07_16_21_284800kb <- full_join(MERGED_SYM_DAT_07_16_21_284800kb, RV_VAX_07_16_21_284800kb, by = c("VAERS_ID"))
MERGED_07_16_21_284800kb_1 <- MERGED_SYM_DAT_VAX_07_16_21_284800kb %>% distinct(VAERS_ID, .keep_all = TRUE)
MERGED_07_16_21_284800kb <- MERGED_07_16_21_284800kb_1 %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)

write.csv(MERGED_07_16_21_284800kb, "/Users/admin/Desktop/MERGED_07_16_21_284800kb.csv")
```
```{r}
MERGED_07_16_21_284800kb$VAX_DATE <- as.Date(MERGED_07_16_21_284800kb$VAX_DATE, "%m/%d/%y") 
MERGED_07_16_21_284800kb$ONSET_DATE <- as.Date(MERGED_07_16_21_284800kb$ONSET_DATE, "%m/%d/%y")
MERGED_07_16_21_284800kb$DATEDIED <- as.Date(MERGED_07_16_21_284800kb$DATEDIED, "%m/%d/%y")
MERGED_07_16_21_284800kb$TODAYS_DATE <- as.Date(MERGED_07_16_21_284800kb$TODAYS_DATE, "%m/%d/%y")
MERGED_07_16_21_284800kb$RECVDATE <- as.Date(MERGED_07_16_21_284800kb$RECVDATE, "%m/%d/%y")

nrow(MERGED_07_16_21_284800kb)
MERGED_07_16_21_284800kb_count_sym1 <- MERGED_07_16_21_284800kb %>% count(SYMPTOM1) %>% arrange(desc(n))
#MERGED_07_16_21_284800kb_count_sym1
```
...
```{r} 
IDs_normalized_total_IDs <- Table_IDs_percent %>% mutate("IDs_normal_ID" = IDs/nrow(MERGED_07_16_21_284800kb)*100)
...
```
```{r}
MERGED_07_16_21_284800kb_AG <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(AGE_YRS != "NA") %>% mutate("AGE_GROUP" = AGE_GROUPED_BY_DECADE(AGE_YRS))
MERGED_07_16_21_284800kb_AG_count <- MERGED_07_16_21_284800kb_AG %>% count(AGE_GROUP)
MERGED_07_16_21_284800kb_count_plot <- ggplot(MERGED_07_16_21_284800kb_AG_count, aes(AGE_GROUP, n, fill = AGE_GROUP)) + geom_bar(stat = "Identity") + geom_text(aes(label = n)) + xlab("AGE GROUPS") + ylab("ADVERSE EVENTS (N)") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=25,vjust=0.5,hjust=0.5, size = 8)) + theme(legend.position = "none") + ggtitle("ALL AEs -> Distribution of AGE GROUPS")
MERGED_07_16_21_284800kb_count_plot
ggsave("MERGED_07_16_21_284800kb_count_plot.png")

MERGED_07_16_21_284800kb_AGE_count <- MERGED_07_16_21_284800kb %>% group_by(AGE_YRS) %>% filter(AGE_YRS != "NA") %>% count(AGE_YRS)
#MERGED_07_16_21_284800kb_AGE_count <- data.frame(MERGED_07_16_21_284800kb_AGE_count, stringsAsFactors = FALSE) %>% mutate("skew" = 3*(mean(n)-median(n))/(sd(n)))
#MERGED_07_16_21_284800kb_AGE_count
```
This is the number of birth defects.
```{r}
MERGED_07_16_21_284800kb_doses <- MERGED_07_16_21_284800kb %>% group_by(VAX_DOSE_SERIES) %>% filter(VAX_DOSE_SERIES >= 0 & VAX_DOSE_SERIES <= 2) %>% count(VAX_DOSE_SERIES) %>% arrange(desc(n))
#MERGED_07_16_21_284800kb_doses
MERGED_07_16_21_284800kb_doses_VM <- MERGED_07_16_21_284800kb %>% group_by(VAX_DOSE_SERIES, VAX_MANU) %>% filter(VAX_DOSE_SERIES >= 0 & VAX_DOSE_SERIES <= 2 & VAX_MANU != "UNKNOWN MANUFACTURER") %>% count(VAX_DOSE_SERIES) %>% arrange(desc(n)) 
MERGED_07_16_21_284800kb_doses_n <- MERGED_07_16_21_284800kb_doses %>% mutate("SUM" = sum(MERGED_07_16_21_284800kb_doses$n)) %>% mutate("PERCENT" = n/SUM*100)
#MERGED_07_16_21_284800kb_doses_n
```
```{r}
BD_07_16_21_284800kb <- MERGED_07_16_21_284800kb %>% filter(BIRTH_DEFECT == TRUE)
nrow(BD_07_16_21_284800kb)
```
This is the number of deaths and the percentage per total AEs.
```{r}
D_07_16_21_284800kb <- MERGED_07_16_21_284800kb %>% group_by(VAERS_ID, DIED) %>% filter(DIED == "Y")
nrow(D_07_16_21_284800kb)
nrow(D_07_16_21_284800kb)/nrow(MERGED_07_16_21_284800kb)*100
```
These are the number of hospitalizations and emergency doctor visits. 
```{r}
HOSPITAL_07_16_21_284800kb  <- MERGED_07_16_21_284800kb  %>% group_by(VAERS_ID, HOSPITAL) %>% filter(HOSPITAL == "Y")
nrow(HOSPITAL_07_16_21_284800kb)

ER_ED_07_16_21_284800kb <- MERGED_07_16_21_284800kb %>% group_by(VAERS_ID, ER_ED_VISIT) %>% filter(ER_ED_VISIT == "Y")
nrow(ER_ED_07_16_21_284800kb)
```
...
```{r}
DEAD_Y_07_16_21_284800kb <- MERGED_07_16_21_284800kb %>% filter(DIED == "Y")
HOSPITAL_Y_07_16_21_284800kb <- MERGED_07_16_21_284800kb %>% filter(HOSPITAL == "Y")
ER_ED_Y_07_16_21_284800kb <- MERGED_07_16_21_284800kb %>% filter(ER_ED_VISIT == "Y")
L_THREAT_Y_07_16_21_284800kb <- MERGED_07_16_21_284800kb %>% filter(L_THREAT == "Y")
DISABLE_Y_07_16_21_284800kb <- MERGED_07_16_21_284800kb %>% filter(DISABLE == "Y")
BIRTH_DEFECT_Y_07_16_21_284800kb <- MERGED_07_16_21_284800kb %>% filter(BIRTH_DEFECT == TRUE)

nrow(DEAD_Y_07_16_21_284800kb)
nrow(HOSPITAL_Y_07_16_21_284800kb)
nrow(ER_ED_Y_07_16_21_284800kb)
nrow(L_THREAT_Y_07_16_21_284800kb)
nrow(DISABLE_Y_07_16_21_284800kb)
nrow(BIRTH_DEFECT_Y_07_16_21_284800kb)

SAES_07_16_21_284800kb <- rbind(DEAD_Y_07_16_21_284800kb, HOSPITAL_Y_07_16_21_284800kb, ER_ED_Y_07_16_21_284800kb, L_THREAT_Y_07_16_21_284800kb, DISABLE_Y_07_16_21_284800kb, BIRTH_DEFECT_Y_07_16_21_284800kb)

SAES_no_dups_07_16_21_284800kb <- subset(SAES_07_16_21_284800kb, !duplicated(subset(SAES_07_16_21_284800kb, select=c(VAERS_ID))))
nrow(SAES_no_dups_07_16_21_284800kb)
Percent = nrow(SAES_no_dups_07_16_21_284800kb)/nrow(MERGED_07_16_21_284800kb)*100
Percent
```
Histogram showing distribution of SAEs according to age group
```{r}
SAES_no_dups_07_16_21_284800kb_AG <- SAES_no_dups_07_16_21_284800kb %>% rowwise() %>% filter(AGE_YRS != "NA") %>% mutate("AGE_GROUP" = AGE_GROUPED_BY_DECADE(AGE_YRS))
SAES_no_dups_07_16_21_284800kb_AG_count <- SAES_no_dups_07_16_21_284800kb_AG %>% count(AGE_GROUP)
SAES_no_dups_07_16_21_284800kb_count_plot <- ggplot(SAES_no_dups_07_16_21_284800kb_AG_count, aes(AGE_GROUP, n, fill = AGE_GROUP)) + geom_bar(stat = "Identity") + geom_text(aes(label = n)) + xlab("AGE GROUPS") + ylab("SEVERE ADVERSE EVENTS (N)") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=25,vjust=0.5,hjust=0.5, size = 8)) + theme(legend.position = "none") + ggtitle("ALL SAEs -> Distribution of AGE GROUPS")
SAES_no_dups_07_16_21_284800kb_count_plot
ggsave("SAES_no_dups_07_16_21_284800kb_count_plot.png")

#MERGED_07_16_21_284800kb_AGE_count <- data.frame(SAES_no_dups_07_16_21_284800kb_AG_count, stringsAsFactors = FALSE) %>% mutate("skew" = 3*(mean(n)-median(n))/(sd(n)))
#MERGED_07_16_21_284800kb_AGE_count
```
...
Table_SAEs_perc <- Table_SAEs %>% mutate("PERC" = round(SAE/(nrow(MERGED_07_16_21_284800kb))*100))
...
COVID_CASES1 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM1)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES1)
COVID_CASES2 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM2)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES2)
COVID_CASES3 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM3)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES3)
COVID_CASES4 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM4)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES4)
COVID_CASES5 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("COVID_CASES" = COVID_CASES(SYMPTOM5)) %>% filter(COVID_CASES != "NA")
#nrow(COVID_CASES5)
...
nrow(COVID_CASES_Total_ENTRY)/nrow(MERGED_07_16_21_284800kb)*100
```
```{r}
#nrow(COVID_CASES_Total)
#nrow(COVID_CASES_Total_ID)
COVID_CASES <- COVID_CASES_Total_ENTRY
#nrow(COVID_CASES)/nrow(MERGED_07_16_21_284800kb)*100
```
```{r}
...
```
```{r}
no_COVID_CASES_count_VM <- COVID_CASES %>% group_by(VAX_MANU) %>% count(VAX_MANU) %>% filter(VAX_MANU != "NA" & VAX_MANU != "UNKNOWN MANUFACTURER") %>% mutate("PERC" = n/(nrow(MERGED_07_16_21_284800kb))*100) %>% mutate("Round" = round(PERC, 2))
...
MERGED_07_16_21_284800kb_FRI1 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM1)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_07_16_21_284800kb_FRI2 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM2)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_07_16_21_284800kb_FRI3 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM3)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_07_16_21_284800kb_FRI4 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM4)) %>% filter(Female_Reprod_Issues != "NA")
MERGED_07_16_21_284800kb_FRI5 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("Female_Reprod_Issues" = FRI(SYMPTOM5)) %>% filter(Female_Reprod_Issues != "NA")

MERGED_07_16_21_284800kb_FRI_Total <- rbind(MERGED_07_16_21_284800kb_FRI1,MERGED_07_16_21_284800kb_FRI2,MERGED_07_16_21_284800kb_FRI3,MERGED_07_16_21_284800kb_FRI4,MERGED_07_16_21_284800kb_FRI5)
MERGED_07_16_21_284800kb_FRI_Total <- data.frame(MERGED_07_16_21_284800kb_FRI_Total, stringsAsFactors = FALSE)

MERGED_07_16_21_284800kb_FRI_Total_ID <- MERGED_07_16_21_284800kb_FRI_Total %>% distinct(VAERS_ID, .keep_all = TRUE)

MERGED_07_16_21_284800kb_FRI_Total_ENTRY <- MERGED_07_16_21_284800kb_FRI_Total_ID %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)

#nrow(MERGED_07_16_21_284800kb_FRI_Total_ENTRY)
MERGED_07_16_21_284800kb_FRI_Total_ENTRY <- data.frame(MERGED_07_16_21_284800kb_FRI_Total_ENTRY, stringsAsFactors = FALSE)
```
```{r}
#nrow(MERGED_07_16_21_284800kb_FRI1)
#nrow(MERGED_07_16_21_284800kb_FRI2)
#nrow(MERGED_07_16_21_284800kb_FRI3)
#nrow(MERGED_07_16_21_284800kb_FRI4)
#nrow(MERGED_07_16_21_284800kb_FRI5)
#MERGED_07_16_21_284800kb_FRI_Total
```
```{r}
#nrow(MERGED_07_16_21_284800kb_FRI_Total)
#nrow(MERGED_07_16_21_284800kb_FRI_Total_ID)
FRI_CASES <- MERGED_07_16_21_284800kb_FRI_Total_ENTRY
nrow(FRI_CASES)
nrow(FRI_CASES)/nrow(MERGED_07_16_21_284800kb)*100
...
Cardiack1 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM1)) %>% filter(Cardiack != "NA")
#nrow(Cardiack1)
Cardiack2 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM2)) %>% filter(Cardiack != "NA")
#nrow(Cardiack2)
Cardiack3 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM3)) %>% filter(Cardiack != "NA")
#nrow(Cardiack3)
Cardiack4 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM4)) %>% filter(Cardiack != "NA")
#nrow(Cardiack4)
Cardiack5 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("Cardiack" = Cardiack(SYMPTOM5)) %>% filter(Cardiack != "NA")
#nrow(Cardiack5)
...
#nrow(Cardiack)/nrow(MERGED_07_16_21_284800kb)*100
```
```{r}
...
```
```{r}
MERGED_07_16_21_284800kb_12_18 <- MERGED_07_16_21_284800kb %>% filter(AGE_YRS >=12 & AGE_YRS <=18)
nrow(MERGED_07_16_21_284800kb_12_18)

MERGED_07_16_21_284800kb_12_18_1 <- MERGED_07_16_21_284800kb_12_18 %>% distinct(VAERS_ID, .keep_all = TRUE)

YOUTH_CASES <- MERGED_07_16_21_284800kb_12_18_1 %>% distinct(AGE_YRS, STATE, SEX, VAX_LOT, VAX_SITE, VAX_ROUTE, VAX_DATE, VAX_NAME, VAX_MANU, RECVDATE, CAGE_YR, CAGE_MO, DIED, HOSPITAL, ER_ED_VISIT, ALLERGIES, ONSET_DATE, PRIOR_VAX, VAX_DOSE_SERIES, L_THREAT, DISABLE,	BIRTH_DEFECT, .keep_all = TRUE)
...
nrow(YOUTH_CASES)/nrow(MERGED_07_16_21_284800kb)*100
```
...
IAE1 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM1 != "NA") %>% mutate("IAE" = IAE(SYMPTOM1)) %>% filter(IAE != "NA")
#nrow(IAE1)
IAE2 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM2 != "NA") %>% mutate("IAE" = IAE(SYMPTOM2)) %>% filter(IAE != "NA")
#nrow(IAE2)
IAE3 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM3 != "NA") %>% mutate("IAE" = IAE(SYMPTOM3)) %>% filter(IAE != "NA")
#nrow(IAE3)
IAE4 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM4 != "NA") %>% mutate("IAE" = IAE(SYMPTOM4)) %>% filter(IAE != "NA")
#nrow(IAE4)
IAE5 <- MERGED_07_16_21_284800kb %>% rowwise() %>% filter(SYMPTOM5 != "NA") %>% mutate("IAE" = IAE(SYMPTOM5)) %>% filter(IAE != "NA")
#nrow(IAE5)
...
#nrow(IAE)/nrow(MERGED_07_16_21_284800kb)*100
```
```{r}
...
```
```{r}
D <- MERGED_07_16_21_284800kb %>% filter(DIED == "Y") %>% filter(year(DATEDIED) <= 2021 & year(DATEDIED) >= 2020) 
MERGED_07_16_21_284800kb_VD_DD <- D %>% mutate("diff_in_days" = difftime(DATEDIED, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n)) %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = as.integer(mean(n))) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(D)*100)
#head(MERGED_07_16_21_284800kb_VD_DD)

#chisq.test(MERGED_07_16_21_284800kb_VD_DD$OBSERVED)

H <- MERGED_07_16_21_284800kb %>% filter(HOSPITAL == "Y") %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2020)
MERGED_07_16_21_284800kb_H_VD_OD <- H %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n))  %>% mutate("OBSERVED" = n)  %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = mean(n)) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(H)*100)
#head(MERGED_07_16_21_284800kb_H_VD_OD)

#chisq.test(MERGED_07_16_21_284800kb_H_VD_OD$OBSERVED)

ER <- MERGED_07_16_21_284800kb %>% filter(ER_ED_VISIT == "Y") %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2020)
MERGED_07_16_21_284800kb_ER_VD_OD <- ER %>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) %>% arrange(desc(n))  %>% mutate("OBSERVED" = n) %>% mutate("Percentage_OBSERVED" = n/sum(n)*100) %>% mutate("EXPECTED" = mean(n)) %>% mutate("Percentage_EXPECTED" = EXPECTED/nrow(ER)*100)
#head(MERGED_07_16_21_284800kb_ER_VD_OD)

#chisq.test(MERGED_07_16_21_284800kb_ER_VD_OD$OBSERVED)
...
```
```{r}
CAUSATION_DEATH_plot <- ggplot() + geom_line(data = MERGED_07_16_21_284800kb_VD_DD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + ylab("PERCENTAGE OF REPORTED DEATHS") + xlab("NUMBER OF DAYS FOLLOWING INJECTION") + geom_line(data = MERGED_07_16_21_284800kb_VD_DD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "DEATHS post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 12)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 12)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) 
CAUSATION_DEATH_plot 
ggsave("CAUSATION_DEATH_plot.png")
```

```{r}
VD_DD_TILE_count <- MERGED_07_16_21_284800kb %>% group_by(DIED, DATEDIED, VAX_DATE) %>% filter(DIED == "Y") %>% filter(year(DATEDIED) <= 2021 & year(DATEDIED) >= 2021) %>% filter(year(VAX_DATE) <= 2021 & year(VAX_DATE) >= 2021)%>% mutate("diff_in_days" = difftime(DATEDIED, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) 
...
```{r}
CAUSATION_HOSP_plot <- ggplot() + geom_line(data = MERGED_07_16_21_284800kb_H_VD_OD, aes(diff_in_days, Percentage_OBSERVED), colour = "orange", size = 2) + xlab("NUMBER OF DAYS FOLLOWING INJECTION") +  ylab("PERCENTAGE OF REPORTED HOSPITALIZATIONS") + geom_line(data = MERGED_07_16_21_284800kb_H_VD_OD, aes(diff_in_days, Percentage_EXPECTED), colour = "yellow", size = 2) + labs(title = "HOSPITALIZATIONS post injection", caption = "Data source: VAERS") + theme(axis.text.y = element_text(colour = "black", size = 14)) + theme(axis.text.x = element_text(colour = "black", angle=0,vjust=0.5,hjust=0.5, size = 14)) + theme(panel.background = element_rect(fill = "#100000", color = "pink")) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
CAUSATION_HOSP_plot
ggsave("CAUSATION_HOSP_plot.png")
```

```{r}
H_VD_OD_TILE_count <- MERGED_07_16_21_284800kb %>% group_by(HOSPITAL, ONSET_DATE, VAX_DATE) %>% filter(HOSPITAL == "Y") %>% filter(year(ONSET_DATE) <= 2021 & year(ONSET_DATE) >= 2021) %>% filter(year(VAX_DATE) <= 2021 & year(VAX_DATE) >= 2021)%>% mutate("diff_in_days" = difftime(ONSET_DATE, VAX_DATE, units = "days")) %>% filter(diff_in_days >= 0 & diff_in_days <=50) %>% count(diff_in_days) 
...
```{r}
MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo1 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM1 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo1)
MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo2 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM2 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo2)
MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo3 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM3 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo3)
MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo4 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM4 == "Myocarditis")
#nrow(MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo4)
MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo5 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM5 == "Myocarditis") 
#nrow(MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo5)
myo_Total <- rbind(MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo1,MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo2,MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo3,MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo4,MERGED_SYM_DAT_VAX_07_16_21_284800kb_myo5)
myo_Total <- data.frame(myo_Total, stringsAsFactors = FALSE)
nrow(myo_Total)
nrow(myo_Total)/nrow(MERGED_07_16_21_284800kb)*100
#myo_Total
...
```
```{r}
#MERGED_07_16_21_284800kb_death_1 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM1 == "Death") 
#nrow(MERGED_07_16_21_284800kb_death_1)
#MERGED_07_16_21_284800kb_death_2 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM2 == "Death") 
#nrow(MERGED_07_16_21_284800kb_death_2)
#MERGED_07_16_21_284800kb_death_3 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM3 == "Death") 
#nrow(MERGED_07_16_21_284800kb_death_3)
#MERGED_07_16_21_284800kb_death_4 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM4 == "Death")
#nrow(MERGED_07_16_21_284800kb_death_4)
#MERGED_07_16_21_284800kb_death_5 <- MERGED_07_16_21_284800kb %>% filter(SYMPTOM5 == "Death") 
#nrow(MERGED_07_16_21_284800kb_death_5)
#death_Total <- rbind(MERGED_07_16_21_284800kb_death_1,MERGED_07_16_21_284800kb_death_2,MERGED_07_16_21_284800kb_death_3,MERGED_07_16_21_284800kb_death_4,MERGED_07_16_21_284800kb_death_5)
#death_Total <- data.frame(death_Total, stringsAsFactors = FALSE)
#nrow(death_Total)
#nrow(death_Total)/nrow(MERGED_07_16_21_284800kb)*100
#death_Total
...
```
```{r}
#MERGED_07_16_21_284800kb_Death <- MERGED_07_16_21_284800kb %>% filter(DIED == "Y") %>% count(DIED)
#MERGED_07_16_21_284800kb_Death

#MERGED_SYM_DAT_VAX_07_16_21_284800kb_Death <- MERGED_SYM_DAT_VAX_07_16_21_284800kb %>% filter(DIED == "Y") %>% count(DIED)
#MERGED_SYM_DAT_VAX_07_16_21_284800kb_Death

#MERGED_07_16_21_284800kb_1_Death <- MERGED_07_16_21_284800kb_1 %>% filter(DIED == "Y") %>% count(DIED)
#MERGED_07_16_21_284800kb_1_Death
```