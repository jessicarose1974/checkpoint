...
```
```{r}
MERGED_SYM_DAT_VAX_07_09_21_279100kb_myo1 <- MERGED_07_09_21_279100kb %>% group_by(VAERS_ID, SYMPTOM1) %>% filter(SYMPTOM1 == "Myocarditis") %>% arrange(desc(AGE_YRS))
#nrow(MERGED_SYM_DAT_VAX_07_09_21_279100kb_myo1)
MERGED_SYM_DAT_VAX_07_09_21_279100kb_myo2 <- MERGED_07_09_21_279100kb %>% group_by(VAERS_ID, SYMPTOM2) %>% filter(SYMPTOM2 == "Myocarditis") %>% arrange(desc(AGE_YRS))
#nrow(MERGED_SYM_DAT_VAX_07_09_21_279100kb_myo2)
MERGED_SYM_DAT_VAX_07_09_21_279100kb_myo3 <- MERGED_07_09_21_279100kb %>% group_by(VAERS_ID, SYMPTOM3) %>% filter(SYMPTOM3 == "Myocarditis") %>% arrange(desc(AGE_YRS))
#nrow(MERGED_SYM_DAT_VAX_07_09_21_279100kb_myo3)
MERGED_SYM_DAT_VAX_07_09_21_279100kb_myo4 <- MERGED_07_09_21_279100kb %>% group_by(VAERS_ID, SYMPTOM4) %>% filter(SYMPTOM4 == "Myocarditis") %>% arrange(desc(AGE_YRS))
#nrow(MERGED_SYM_DAT_VAX_07_09_21_279100kb_myo4)
MERGED_SYM_DAT_VAX_07_09_21_279100kb_myo5 <- MERGED_07_09_21_279100kb %>% group_by(VAERS_ID, SYMPTOM5) %>% filter(SYMPTOM5 == "Myocarditis") %>% arrange(desc(AGE_YRS))
