---
title: "The Knitr/R Markdown document for VAERS analysis"
author: "Dr. Jessica Rose"
date: "21 May, 2021"
output: html_document
---
This is an R Markdown sheet where the plots are generated from for the VAERS data.
```{r}
library("readr")
library("tidyverse")
library("dplyr")
...
```
MAKING A TABLE OF THE DATA FOR COVID-19
```{r}
Table_IDs_COVID_percent <- data.frame(
  DATE = as.Date(c("1/16/21", "1/23/21", "1/30/21", "2/13/21", "2/27/21", "3/5/21", "3/12/21", "3/19/21", "3/26/21", "4/2/21", "4/9/21"), "%m/%d/%y"),
  COVID = as.numeric(c("194", "254", "326", "619", "717", "776", "943", "1057", "1169", "1267", "1375")),
