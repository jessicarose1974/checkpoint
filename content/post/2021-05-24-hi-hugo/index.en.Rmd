...
```
```{r}
#MERGED_07_02_21_418000kb_0_50 <- MERGED_07_02_21_418000kb %>% filter(AGE_YRS < 50) %>% arrange(desc(AGE_YRS))
...
```{r}
D_07_02_21_418000kb <- MERGED_07_02_21_418000kb %>% group_by(VAERS_ID, DIED) %>% filter(DIED == "Y")
DEAD_07_02_21_418000kb <- subset(D_07_02_21_418000kb, !duplicated(subset(D_07_02_21_418000kb, select=c(VAERS_ID))))
nrow(DEAD_07_02_21_418000kb)
```
```{r}
HOSPITAL_07_02_21_418000kb  <- MERGED_07_02_21_418000kb  %>% group_by(VAERS_ID, HOSPITAL) %>% filter(HOSPITAL == "Y")
nrow(HOSPITAL_07_02_21_418000kb)
...
MERGED_07_02_21_418000kb_12_18
MERGED_07_02_21_418000kb_12_18_female <- MERGED_07_02_21_418000kb_12_18 %>% group_by(SEX) %>% count(SEX) %>% mutate("PERC_FEMALE" = n/nrow(MERGED_SYM_DAT_VAX_06_25_21_396000kb_12_18)*100)
MERGED_07_02_21_418000kb_12_18_female
MERGED_07_02_21_418000kb_12_18
